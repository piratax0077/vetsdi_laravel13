            ...
            return function(e, t) {
                ...
                value: function() {
                    this.prototype.Emitter = c, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
                        ...
                        renameFile: null,
                        forceFallback: !1,
                        dictDefaultMessage: "Arrastre o seleccione aquí",
                        dictFallbackMessage: "Tu navegador no soporta arrastre de archivos.",
                        dictFallbackText: "Please use the fallback form below to upload your files like in the olden days.",
                        dictFileTooBig: "El archivo es demasiado grande ({{filesize}}MiB). Solo se permiten: {{maxFilesize}}MiB.",
                        ...
                        success: function(e) {
                        	respuesta = JSON.parse(e.xhr.response);
                        	if(respuesta.success) {
                                $("#archivos").append('<button type="button" class="btn btn-default"><i class="mr-2 fas fa-check"></i>' + respuesta.nombre+ '</button>');
                                setTimeout(function(){ 
                                    e.previewElement.parentNode.removeChild(e.previewElement);
                                    $("#pendientes").removeClass("d-none");
                        		...
                        		var o = e.previewElement.querySelectorAll("[data-dz-errormessage]")[0];
                        		o.append(respuesta.message);
