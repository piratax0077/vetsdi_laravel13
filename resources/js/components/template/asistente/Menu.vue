                ...
                <div>
                    ...
                    <div id="nav-user-link">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item">
                                <form id="close" action="/logout" method="POST">
                ...
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li class="nav-item pcoded-hasmenu active pcoded-trigger" id="navEscritorio">
                        ...
                        <ul class="pcoded-submenu">
                            <li>
                                <router-link to="/Asistente_Laboratorio">Mi Escritorio</router-link>
                            </li>
                            <li>
                                <router-link to="/Asistente_Laboratorio/Pacientes">Pacientes</router-link>
                            </li>
                            <li>
                                <router-link to="/Asistente_Laboratorio/Reservar_Hora_Medica">Reservar Hora</router-link>
                            </li>
                            <li>
                                <router-link to="/Asistente_Laboratorio/Agenda_Laboratorio">Agenda de Laboratorio</router-link>
                            </li>
                            <li>
                                <router-link to="/Asistente_Laboratorio/Resultado_Examen">Resultado de Exámenes</router-link>
                            </li>
                            <li>
                                <router-link to="/Asistente_Laboratorio/Cotizar_Examen">Cotizar Exámen</router-link>
                            </li>
                            <li>
                                <router-link to="/Asistente_Laboratorio/Flujo_Caja">Flujo de Caja</router-link>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item pcoded-hasmenu" id="navConfig">
                        ...
                        <ul class="pcoded-submenu">
                            <li>
                                <router-link to="/Asistente_Laboratorio/Perfil">Editar Perfil</router-link>
                            </li>
                        </ul>
                    </li>
