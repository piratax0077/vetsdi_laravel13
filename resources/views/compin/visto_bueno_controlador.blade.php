...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Visto bueno controlador</li>
</ul>
@endsection
    ...
    <div class="pcoded-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <main>
                        <section id="visto-bueno" class="view active">
                        <div class="grid">
                            <article class="panel">
                                <div class="panel-head"><div><p class="eyebrow">CONTROLADOR</p><h3>Visto bueno final</h3></div><span class="badge green">Control interno</span></div>
                                <div class="panel-body">
                                    <p>El controlador verifica que la comisión no dejó observaciones y autoriza el paso a pago.</p>
                                    <div class="actions"><button class="action success" id="controller-approve">Dar visto bueno</button><button class="action danger" id="controller-reject">Devolver a comisión</button></div>
                                </div>
                            </article>
                            <article class="panel"><div class="panel-head"><div><p class="eyebrow">RESUMEN</p><h3>Condiciones para pago</h3></div></div><div class="panel-body"><div class="review-card"><div class="review-row"><span>Comisión aprobada</span><strong id="summary-commission">No</strong></div><div class="review-row"><span>Controlador aprobado</span><strong id="summary-controller">No</strong></div><div class="review-row"><span>Estado de pago</span><strong id="summary-payment">No enviado</strong></div></div></div></article>
                        </div>
                    </section>
                    </main>
