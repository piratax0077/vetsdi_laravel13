...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Comisión Médica</li>
</ul>
@endsection
    ...
    <div class="pcoded-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <main>
                        <section id="comision" class="view active">
                        <div class="grid">
                            <article class="panel">
                                <div class="panel-head"><div><p class="eyebrow">COMISIÓN MÉDICA</p><h3>Revisión técnica</h3></div><span class="badge amber">En análisis</span></div>
                                <div class="panel-body">
                                    <div class="review-card">
                                        <div class="review-row"><span>Informe contador revisado</span><strong>Sí</strong></div>
                                        <div class="review-row"><span>Antecedentes médicos consistentes</span><strong id="medical-check">Pendiente</strong></div>
                                        <div class="review-row"><span>Días de reposo</span><strong>4 días</strong></div>
                                        <div class="review-row"><span>Observaciones</span><strong id="commission-observation">Sin revisión</strong></div>
                                    </div>
                                    <div class="actions"><button class="action warning" id="commission-approve">Aprobar revisión comisión</button><button class="action danger" id="commission-reject">Observar expediente</button></div>
                                </div>
                            </article>
                            <article class="panel"><div class="panel-head"><div><p class="eyebrow">DOCUMENTOS</p><h3>Adjuntos recibidos</h3></div></div><div class="panel-body"><ul><li>Licencia médica digital LM-2026-0021</li><li>Informe remuneraciones COMPIN PDF</li><li>Resumen últimos 3 sueldos</li></ul></div></article>
                        </div>
                    </section>
                    </main>
