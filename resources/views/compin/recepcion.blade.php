...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ ROUTE('compin.home') }}">Escritorio Compin</a></li>
    ...
    <div class="pcoded-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <main>
                        <section id="recepcion" class="view">
                            <div class="grid">
                                <article class="panel"><div class="panel-head"><div><p class="eyebrow">TRAZABILIDAD</p><h3>Flujo completo</h3></div></div><div class="panel-body"><div class="flow" id="flow-steps"></div></div></article>
                                <article class="panel"><div class="panel-head"><div><p class="eyebrow">BITÁCORA</p><h3>Eventos</h3></div></div><div class="panel-body"><button class="action secondary" id="reset-flow">Reiniciar demo</button><div class="log" id="audit-log"></div></div></article>
                            </div>
                        </section>
                    </main>
