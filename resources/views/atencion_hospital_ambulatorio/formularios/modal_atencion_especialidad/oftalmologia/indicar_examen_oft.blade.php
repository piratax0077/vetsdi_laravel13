    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title mt-1" id="modal_indicar_examen">Indicar Examenes Especialidad Oftalmología</h5>
                             ...
                             <div class="form-group fill">
                                ...
                                <select class="form-control form-control-sm" name="" id="">
                                    ...
                                    <optgroup label="CEREBRO Y FOSA POSTERIOR">
                                        ...
                                        <option value="41">TAC CEREBRO CON CONTRASTE SIN CONTRASTE</option>
                                        <option value="42">RNM CEREBRO </option>
                                        <option value="43">TAC FOSA POSTERIOR CON CONTRASTE</option>
                                        <option value="44">TAC FOSA POSTERIOR CON CONTRASTE SIN CONTRASTE</option>
