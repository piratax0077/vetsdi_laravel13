    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title mt-1" id="modal_eval_hab_preart">Riesgo Dependencia CUDYR </h5>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control form-control-sm" name="resp_cudyr" id="resp_cudyr">
                        </div>
                    </div>
                </div>
                <div class="row">
                                           ...
                                           <div class="form-row mt-7">
                                            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" style="color:red;font-weight:bold;" data-input_igual="total_cr" name="ptos_criesg" id="ptos_criesg" onchange="cargarIgual('ptos_criesg');">
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-9 col-lg-9 col-xl-9">
                                                <div class="form-group">
...
<script>
    ...
    function cud_riesgo() {
        ...
        if($('#ptos_criesg').val()<12)
        {
            $('#ptos_criesg').css('color', 'blue');
        }
        else
        {
            $('#ptos_criesg').css('color', 'red');
        }
