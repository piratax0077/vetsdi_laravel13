    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title mt-1" id="modal_eval_hab_preart">Evaluación de la metría</h5>
                ...
                <form>
                    <div class="form-row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-1">
                            <h6 class="mb-3">Prueba Índice - Nariz</h6>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-1">
                            <h6 class="mb-3">Prueba Talón - Rodilla</h6>
                            <div class="form-group">
                                <label class="floating-label-activo-sm">Evaluación</label>
                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="obs_resp" id="obs_resp"></textarea>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <h6 class="mb-3">Diadococinesia</h6>
                            <div class="form-group">
                                <label class="floating-label-activo-sm">Evaluación</label>
                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="obs_resp" id="obs_resp"></textarea>
                            </div>
