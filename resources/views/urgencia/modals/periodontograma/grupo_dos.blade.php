...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
        ...
        <style>
            ...
            #i18,#i17,#i16,#i15,#i14,#i13,#i12,#i11{
                background: url('{{ asset('images/dental/periodontograma/img/periodontograma-oblicuas.png') }}'); repeat-x ;
                    width: 100%;
                    height:18px;
                }
            /*background-position:
...
<body style="width: 100%;">
	<div id="contenido" style="width: 100%;">
		...
		<div id="wrapper" style="width: 100%;">
			<table id="superior" style="width: 100%;">
				<tr>
					<td style="padding:5px;width:100%;">SUPERIOR</td>
					<td style="padding:5px;width:100%;text-align:left;"><input type="button" style="width:120px;"value="Guardar Datos" onclick="guardardatos();"></td>
				</tr>
			</table>
				...
				<tr >
					<td colspan="6">
						<table id="tabla-1" style="width: 100%;" >
							<form name ="grafico1" id="grafico1" action="#" style="width: 100%;">
								<tr>
									<td class="titulo">Pieza Dental</td>
								...
								<tr>
									...
									<td class="borde"><div id="f15"></div></td>
									<td class="borde"><div id="f14"></div></td>
									{{--  <td class="borde"></td>
									<td class="borde"></td>
									<td class="borde"></td>  --}}
								</tr>
