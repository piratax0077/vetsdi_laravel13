<div id="modal_hemorragia" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal_info2"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white mt-1 f-18" id="modal_info1"> ANTECEDENTES HEMORRÁGICOS</h5>
            ...
            <div class="modal-body">
                            ...
                            <div class="card-body ">
                                <form id="form_antecedente_hemorragia" method="POST"
                                    ...
                                    <input type="hidden" name="paciente_antecedente_hemorragia_atencion_dental"
                                        id="paciente_antecedente_hemorragia_atencion_dental"
                                        value="{{ $paciente->id }}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 mx-auto">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                name="lugar_hemorragia_ficha_atencion"
                                                id="lugar_hemorragia_ficha_atencion">
                                        </div>
                                        <div class="form-group col-md-6 mx-auto">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 d-flex justify-content-end">
                                            <button type="button" onclick="reset_form('form_antecedente_hemorragia')"
                ...
                <table id="tabla_antecedentes_hemorragia" class="table table-sm">
                    <thead>
                        <tr>
            ...
            <div class="modal-footer">
                <button type="button" onclick="reset_form('form_antecedente_hemorragia')" class="btn btn-success"
