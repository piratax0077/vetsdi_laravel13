        ...
        <div class="row mx-0">
            <div class="col-md-12">
                <ul class="nav nav-tabs-secciones mb-3 mt-3" id="oft" role="tablist">
                    ...
                    <li class="nav-item-secciones">
                        <a class="nav-secciones  text-uppercase" id="atencion_kine-tab" data-toggle="tab" href="#atencion_kine" role="tab" aria-controls="atencion_kine" aria-selected="true">Atención kinesiológica</a>
                    </li>
                    <li class="nav-item-secciones">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                               ...
                               <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    <button type="button" class="btn btn-success btn-block btn-sm mt-1" onclick="examenes_nutri();"><i class="fa fa-plus"></i> Indicar examen Especialidad</button>
                                </div>
                                <div class="form-group col-md-4">
