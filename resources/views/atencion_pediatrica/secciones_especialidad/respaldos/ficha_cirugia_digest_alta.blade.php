                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="row">
                                                                        <div class="form-group col-md-12">
                                                                            ...
                                                                            <select name="dolor" id="dolor" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('dolor','div_detalle_dolor','dolor_cda',2)">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="row">
                                                                        <div class="form-group col-md-12">
                                                                            ...
                                                                            <select name="ceg_cda" id="ceg_cda" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('ceg_cda','div_detalle_ceg_cda','ceg_cda_def',2)">
                                                                                <option value="0">Seleccione</option>
                                                                                <option value="1">No</option>
                                                                                <option value="2">Si</option>
                                                                            </select>
