        ...
        <div class="row mx-0">
            <div class="col-sm-12 col-md-12">
                <ul class="nav nav-tabs-secciones mb-3 mt-3" id="orl" role="tablist">
                    ...
                    <li class="nav-item-secciones">
                        <a class="nav-secciones text-uppercase" id="rinofibro-tab" data-toggle="tab" href="#rinofibro" role="tab" aria-controls="rinofibro" aria-selected="false">Endoscopía Digestiva Baja</a>
                    </li>
				</ul>
            </div>
            <div class="col-sm-12 col-md-12">
                        ...
                        <div class="tab-pane fade" id="endosc_gastrica" role="tabpanel" aria-labelledby="endosc_gastrica-tab">
                            <div class="row bg-white shadow-none rounded mx-1">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-12 mt-3 mb-0">
                                            <h6 class="f-16 text-c-blue">Informe Endoscopía Coloproctológica</h6>
                                            <hr>
                                        </div>
                                    </div>
									<div class="row">
										<div class="col-md-6 mt-3 mb-0">
                                            <label class="f-16 text-c-blue"Premedicación</label>
                                            <hr>
                                        </div>
										<div class="col-md-6 mt-3 mb-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header" id="antec_colop>
                                                    <button class="accor-closed btn pt-1 pb-0 pl-1 btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#antec_coloprocto_c" aria-expanded="false" aria-controls="antec_coloprocto_c">
                                                        Antecedentes
                                                    </button>
                                                </div>
                                                <div id="antec_coloprocto_c" class="collapse show" aria-labelledby="antec_coloprocto" data-parent="#antec_coloprocto">
                                                    <div class="card-body-aten shadow-none">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-12 mx-auto">
                                                                <label class="floating-label-activo-sm">Antecedentes Generales</label>
                                                                <textarea class="form-control caja-texto form-control-sm" rows="1"  onfocus="this.rows=4" onblur="this.rows=1;" name="antec_endo_colo_gen" id="antec_endo_colo_gen"></textarea>
                                                            </div>
                                                            <div class="form-group col-md-12 mx-auto">
                                                                <label class="floating-label-activo-sm">Antecedentes Coloproctológicos</label>
                                                                <textarea class="form-control caja-texto form-control-sm" rows="1"  onfocus="this.rows=4" onblur="this.rows=1;" name="antec_endo_colo_cp" id="antec_endo_colo_cp"></textarea>
                                                            </div>
                                                        </div>
													</div>
                                                </div>
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header" id="tacto_rectal_endo">
                                            ...
                                            <div class="card">
												...
												<div class="form-row">
													<div class="col-sm-12">
														<div class="form-group fill">
															<div class="form-group col-md-12 mx-auto">
																<label class="floating-label-activo-sm">Informe Colonoscopía</label>
																<textarea class="form-control caja-texto form-control-sm" rows="1"  onfocus="this.rows=6" onblur="this.rows=1;" name="antec_endo_colo_cp" id="antec_endo_colo_cp"></textarea>
															</div>
														</div>
													</div>
												</div>
