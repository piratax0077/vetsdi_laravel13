    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title mt-1 f-18" id="modal_info1"> Grados de desarrollo Tunner Masculino</h5>
                        ...
                        <form>
                            <div class="form-row">
                                <div class="form-group fill col-sm-4">
                                    ...
                                    {{-- <input type="text" class="form-control form-control-sm" name="m_tanner" id="m_tanner"> --}}
                                    <select class="form-control form-control-sm" name="m_tanner" id="m_tanner">
                                ...
                                <div class="form-group fill col-sm-4">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="m_edad" id="m_edad">
                                </div>
                                <div class="form-group fill col-sm-4">
                                    <button type="button" class="btn btn-success btn-sm btn-block" onclick="registrar_tunner('m');">Añadir</button>
                                </div>
                                <div class="form-group fill col-sm-8">
                                    <label class="floating-label">Comentarios sobre el desarrollo</label>
                                    <textarea type="text" class="form-control form-control-sm" rows="1" onfocus="this.rows=3" onblur="this.rows=1;" name="m_cometarios_tanner" id="m_cometarios_tanner"></textarea>
                                </div>
