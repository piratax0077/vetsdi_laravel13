                                ...
                                <div class="card-body pb-0">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-sm-12 col-md-4 col-lg-4">
                                            ...
                                            <textarea class="form-control caja-texto form-control-sm " rows="1"  onfocus="this.rows=8" onblur="this.rows=1;" name="ingreso_sol_pab_modal_diagnostico_preoperatorio" id="ingreso_sol_pab_modal_diagnostico_preoperatorio">{{ $fichaAtencion->hipotesis_diagnostico }}</textarea>
                                        </div>
                                        <div class="form-group col-sm-12 col-md-4 col-lg-4">
