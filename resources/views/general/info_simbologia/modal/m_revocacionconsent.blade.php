    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body px-4">
                ...
                <!--TABLA-->
                <h6 class="tit-gen">Consentimientos informados activos</h6>
                 <div class="form-row">
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row" id="div_m_rev_cons_btn_aprobacion_solicitud" style="display:;">
                                    <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <button type="button" class="btn btn-info btn-sm btn-block" onclick="registar_solicitar_autorizacion_revocacion();"><i class="feather icon-check"></i> Solicitar autorización de Revocación</button>
                                    </div>
                                </div>
                                ...
                                <div class="form-row" id="div_m_rev_cons_btn_aprobacion_ok" style="display: none;">
                                    ...
                                    <div class="form-group col-sm-12">
                                        <button type="button" class="btn btn-info btn-sm btn-block" onclick="limpiar_revocacion()"><i class="feather icon-check"></i> Crear nueva Revocación</button>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-12">
                ...
                <!--TABLA-->
                <h6 class="tit-gen mt-3">Reversas Consentimientos informados</h6>
