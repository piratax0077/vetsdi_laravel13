...
@section('page-script-med-exa')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).off('change.vetExamen', '#tipo_examen_d')
                .on('change.vetExamen', '#tipo_examen_d', function(e) {
                e.preventDefault();
                var tipo_examen = $(this).val();

                $("#sub_tipo_examen_d").html('<option value="">Cargando...</option>');
                $("#examen_d").html('<option value="">Seleccione</option>');
                $.ajax({
                    ...
                    .done(function(response) {
                        ...
                        else  $('#imagenologia_con_contraste_d').prop('checked', false).attr('disabled','disabled');
                    })
                    .fail(function(xhr) {
                        $("#sub_tipo_examen_d").html('<option value="">No fue posible cargar los subtipos</option>');
                        console.error('Error al cargar subtipos de examen', xhr.responseText);
                    })

            });

            {{--  buscar examenes por el sub tipo de examen  --}}
            $(document).off('change.vetExamen', '#sub_tipo_examen_d')
                .on('change.vetExamen', '#sub_tipo_examen_d', function(e) {

                e.preventDefault();
                var sub_tipo_examen = $(this).val();

                $("#examen_d").html('<option value="">Cargando...</option>');
                $.ajax({
                    ...
                    .fail(function(xhr) {
                        $("#examen_d").html('<option value="">No fue posible cargar los exámenes</option>');
                        console.error('Error al cargar exámenes', xhr.responseText);
                    })
