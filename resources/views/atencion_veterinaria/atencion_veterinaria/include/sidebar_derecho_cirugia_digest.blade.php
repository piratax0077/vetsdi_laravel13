    ...
    <div id="formularios_cir_digest" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
        ...
        <header class="bs-canvas-header p-3 bg-info overflow-auto d-flex justify-content-between">
            ...
            <h5 class="d-inline-block text-light mb-0 float-right">Formularios CirugÃ­a Digestiva</h5>
                ...
                <div class="card-sidebar">
                    ...
                    <div id="collapse_solicitud_examenes" class="collapse" aria-labelledby="heading_solicitud_examenes" data-parent="#accordion_side_bar">
                        ...
                        <div class="card-body-sidebar">
                            ...
                            <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="mostrar_modal_ex_rx_cirugia();">+ Orden radiologÃ­a</button>
