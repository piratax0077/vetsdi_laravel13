<div id="m_acprocedimientos" class="modal fade " tabindex="-1" role="dialog" aria-labelledby="m_acprocedimientos" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header bg-info">
				<h5 class="modal-title text-white text-center">Consentimiento Informado Procedimientos Médicos</h5>
			...
			<div class="modal-body">
				...
				<div class="form-row">
					<div class="form-group fill col-sm-12">
						...
						<input type="text" class="form-control form-control-sm" id="prof"name="prof"> <p>Gineco-Obstétra.<p>
					</div>
				</div>
				<div class="form-row">
					<div class="col-md-12">
