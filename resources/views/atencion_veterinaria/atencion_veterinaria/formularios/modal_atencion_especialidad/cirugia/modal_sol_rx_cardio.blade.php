    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-center">Solicitud Examen de Radiológicos cardiovasculares</h5>
                                ...
                                <table class="table table-bordered table-xs">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle">Nº Orden</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="align-middle"><span>03/12/20</span></td>
                                            <td class="align-middle">7217821</td>
                                            <td class="align-middle">fulano de tal</td>
                                            <td class="align-middle">6598895-k</td>
                                            <td class="align-middle">Reflujo</td>
                                            <td class="align-middle">se solicita estudio HP</td>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-sm" onclick="cerrarsol_examen_rx_cardio();" data-dismiss="modal"><i class="feather icon-x"></i> Cancelar</button>
