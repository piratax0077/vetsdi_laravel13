<div id="m_cisto" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="m_cisto" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white text-center">Solicitud Examen de Cistoscopía </h5>
                                ...
                                <table class="table table-bordered table-xs">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">se solicita estudio hematuria</td>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-sm" onclick="cerrarsol_examen_cisto();" data-dismiss="modal">Cancelar</button>
...
<script>
    ...
    function sol_examen_cistoscopia()
    {
        $('#m_cisto').modal('show');
    }
    function cerrarsol_examen_cisto(){
        $('#m_cisto').modal ('hide');
      }
