            ...
            <div class="col-sm-12 col-md-12">
                <ul class="nav nav-tabs-secciones mb-3 mt-3" id="orl" role="tablist">
                    <li class="nav-item-secciones">
                        <a class="nav-secciones active text-uppercase" id="atencion_cardiologia_gen-tab" data-toggle="tab"
                            href="#atencion_cardiologia_gen" role="tab" aria-controls="atencion_cardiologia_gen"
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <form action="{{ route('fichaAtencion.registrar_ficha_cdg') }}" method="POST">
                    ...
                    @php
                        ...
                        $array_examen_especialidad_tipo = [];
                        /*
                    ...
                    <div class="tab-content" id="cardio-contenido">
                        ...
                        <div class="tab-pane fade show active" id="atencion_cardiologia_gen" role="tabpanel"
                            aria-labelledby="atencion_cardiologia_gen-tab">
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                                    <!--FORMULARIOS-->
                                    <div class="row">
                        ...
                        <div class="tab-pane fade" id="endosc_gastrica" role="tabpanel"
                            aria-labelledby="endosc_gastrica-tab">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-center mb-3">
                                            <input type="submit" class="btn btn-success mt-1"
                                                onclick="agregar_medicamentos_ficha(); agregar_examenes_ficha(); "
                                                value="Guardar Examen e ir a su Agenda">
                                            <button type="button" class="btn btn-success mt-1"
                                                onclick="visualizar_pdf_examen('eda');">Ver Examen PDF</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
