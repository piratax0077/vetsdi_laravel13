    ...
    <div class="row">
        @if(!empty(session('lic_token')) && session('lic_estado') == 1)
            @if (isset($fichaAtencion) && $fichaAtencion->hipotesis_diagnostico != null)
                <div class="col-sm-12 col-md-6 text-center">
                    <div class="btn-group btn-group-sm w-100" data-toggle="buttons">
                        <button type="button" id="btn_agregar_medicamento" class=" btn_agregar_medicamento btn btn-info btn-sm mt-1 wid-80" onclick="i_lente();"><i class="feather icon-plus"></i>Receta de lentes</button>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="btn-group btn-group-sm w-100" data-toggle="buttons">
                        <button type="button" id="btn_agregar_examen" class=" btn_agregar_examen btn btn-info btn-sm mt-1 wid-80" onclick="i_examen_espoft();"><i class="feather icon-plus"></i>Examen especialidad</button>
            ...
            @else
                <div class="col-sm-12 col-md-6 text-center">
                    <div class="btn-group btn-group-sm w-100" data-toggle="buttons">
                        <button type="button" disabled="disabled" id="btn_agregar_medicamento" class=" btn_agregar_medicamento btn btn-info btn-sm mt-1 wid-80" onclick="i_lente();"><i class="feather icon-plus"></i>Receta de lentes</button>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="btn-group btn-group-sm w-100" data-toggle="buttons">
                        <button type="button" disabled="disabled" id="btn_agregar_examen" class=" btn_agregar_examen btn btn-info btn-sm mt-1 wid-80" onclick="i_examen_espoft();"><i class="feather icon-plus"></i>Examen especialidad</button>
