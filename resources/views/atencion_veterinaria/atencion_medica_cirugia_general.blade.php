...
@section('Content')
    ...
    <div class="pcoded-main-container">
                ...
                <div class="col-md-12">
                    <div class="tab-content" id="at-oftalmo">
                        ...
                        <div class="tab-pane fade show active" id="atender" role="tabpanel" aria-labelledby="atender-tab">
                            @include('atencion_veterinaria.secciones_especialidad.ficha_cirugia_general')
                        </div>
                        <!--Licencia-->
		...
		@include("atencion_veterinaria.include.sidebar_derecho_cirugia_general")
    ...
    {{--  @include('atencion_veterinaria.formularios.modal_atencion_especialidad.cirugia.modal_sol_gastro_func')  --}}
    ...
    @include('atencion_veterinaria.formularios.modal_atencion_general.modal_indicar_examenes')
