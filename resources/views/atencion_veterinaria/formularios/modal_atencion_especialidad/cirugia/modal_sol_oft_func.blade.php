    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white text-center">Solicitud Exámenes Funcionales Otorrinolaringología</h5>
                ...
                <form>F
                    <div class="form-row mt-1">
                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <select class="js-example-basic-multiple select2" name="ex-funcional" id="ex-funcional_orl" multiple="multiple">
                                <option value="1"> 17 01 001  &nbsp;  |  &nbsp; AUDIOMETRÍA ADULTO	</option>
                                <option value="2"> 17 01 003  &nbsp;  |  &nbsp; AUDIOMETRÍA PEDIÁTRICA	</option>
                                <option value="3"> 17 01 004  &nbsp;  |  &nbsp;IMPEDANCIOMETRÍA</option>
                                <option value="4"> 17 01 006 &nbsp;  |  &nbsp; ESTUDIO FUNCIÓN TUBÁRICA</option>
                                <option value="5"> 17 01 007 &nbsp;  |  &nbsp; EXAMEN FUNCIONAL DEL OCTAVO PAR</option>
                                <option value="6"> 17 01 055 3 &nbsp;  |  &nbsp;RINOMANOMETRÍA </option>
                                <option value="7"> 17 01 045 &nbsp;  |  &nbsp; </option>
                                <option value="8"> 17 01 008  &nbsp;  |  &nbsp; </option>
                                <option value="9"> 17 01 009&nbsp;  |  &nbsp;  </option>
                                <option value="11"> 17 01 056  &nbsp;  |  &nbsp;	 </option>
                                <option value="10"> 17 01 015 &nbsp;  |  &nbsp; </option>
                                <option value="12"> 17 01 016&nbsp;  |  &nbsp; 	</option>
                                <option value="13"> 17 01 017 &nbsp;  |  &nbsp; C/U</option>
                            </select>
                        </div>
                        <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
