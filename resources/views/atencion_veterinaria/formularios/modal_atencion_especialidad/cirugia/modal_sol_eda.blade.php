<div id="m_eda" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="m_eda" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white text-center">Solicitud Examen de Endoscopía Digestiva Alta </h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-sm" onclick="cerrarsol_examen_endosc_eda();" data-dismiss="modal">Cancelar</button>
...
<script>
    ...
    function sol_examen_endosc_eda()
    {
        $('#m_eda').modal('show');
    }
    function cerrarsol_examen_endosc_eda() {
        $('#m_eda').modal ('hide');
      }
