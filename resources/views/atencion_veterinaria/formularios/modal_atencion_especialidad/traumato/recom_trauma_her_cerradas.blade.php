<div id="m_ind_traumato_hcerradas" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="m_ind_traumato_hcerradas" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-center">Recomendaciones generales acerca del cuidado post quirúrgico de las heridas cerradas</h5>
