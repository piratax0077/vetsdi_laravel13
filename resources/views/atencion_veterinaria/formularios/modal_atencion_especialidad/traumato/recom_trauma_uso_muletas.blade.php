<div id="m_ind_traumato_usomuletas" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="m_ind_traumato_usomuletas" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white text-center">Recomendaciones generales acerca del uso de muletas</h5>
                <button type="button" class="close text-white" data-dismiss="modal" onclick="$('#m_ind_traumato_usomuletas').modal('hide')" aria-label="Close"><span aria-hidden="true">×</span></button>
            </div>
