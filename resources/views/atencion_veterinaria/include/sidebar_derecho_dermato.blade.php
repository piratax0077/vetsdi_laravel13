   <!--Sidebar 3 (DERMATOLOGIA)-->
    ...
    <div id="formularios_dermato" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
        ...
        <header class="bs-canvas-header p-3 bg-info overflow-auto d-flex justify-content-between">
            ...
            <button type="button" class="bs-canvas-close close" onclick="$('#formularios_dermato').modal('hide')" aria-label="Close" data-dismiss="modal"> <span aria-hidden="true" class="text-white">&times;</span></button>
