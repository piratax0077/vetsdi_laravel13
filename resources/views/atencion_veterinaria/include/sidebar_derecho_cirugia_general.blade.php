    ...
    <div id="formularios_cir_gen" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
        ...
        <header class="bs-canvas-header p-3 bg-info overflow-auto d-flex justify-content-between">
            ...
            <h5 class="d-inline-block text-light mb-0 float-right">Formularios CirugÃ­a General</h5>
        ...
        <div class="bs-canvas-content">
                ...
                <div class="card-sidebar">
                    ...
                    @include("atencion_veterinaria.formularios.modal_atencion_especialidad.cirugia.modal_cuidados_herida_operatoria")
