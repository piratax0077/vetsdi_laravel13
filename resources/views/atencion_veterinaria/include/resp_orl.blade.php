                ...
                <div class="card-sidebar">
                    ...
                    <div id="collapse_recom" class="collapse" aria-labelledby="heading_recom" data-parent="#accordion_side_bar">
                        <div class="card-body-sidebar">
                            ...
                            <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="irge()";>+ Recomendaciones Paciente con reflujo Gástroesofágico</button>
                        </div>
                    </div>
                    ...
                    @include("atencion_medica.formularios.modal_atencion_especialidad.cirugia.modal_recomendaciones_reflujo")
