...
@include('atencion_veterinaria.modal_declaraciones_edo')
...
@include('general.sidebar.modal_form_generales.modal_vacunacion_desparasitacion')
...
@include('atencion_veterinaria.sidebars.antecedentes_paciente')
@include('atencion_veterinaria.sidebars.formularios_atencion')
@include('atencion_veterinaria.sidebars.formularios_signos_vitales')
