                                               ...
                                               <div class="tab-pane fade show active" id="examen_conciencia" role="tabpanel" aria-labelledby="examen_conciencia-tab">
                                                    <div class="form-row">
                                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="eval_conciencia" data-titulo="Evaluación de Conciencia" data-seccion="Funciones Corticales" id="eval_conciencia" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('eval_conciencia','div_eval_conciencia','obs_eval_conciencia',2);">
                                                                    ...
                                                                    <option value="1" data-valor="Normal y Alerta">Normal y Alerta</option>
                                                                    <option value="2" data-valor="Observaciones">Observaciones</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group" id="div_eval_conciencia" style="display:none;">
                                                                <label class="floating-label-activo-sm " for="obs_eval_conciencia">Obs. Estado Conciencia(Describir)</label>
                                                        ...
                                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="conciencia_dism" data-titulo="Conciencia Disminuida" data-seccion="Funciones Corticales" id="conciencia_dism" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('conciencia_dism','div_conciencia_dism','obs_conciencia_dism',2);">
                                                                    <option value="0">Seleccione</option>
                                                                    <option value="1" data-valor="Normal">Normal</option>
                                                                    <option value="2" data-valor="Disminuido">Disminuido (Describir)</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group" id="div_conciencia_dism" style="display:none;">
                                                                <label class="floating-label-activo-sm " for="obs_conciencia_dism">Obs.Conciencia Disminuida (Describir)</label>
                                                        ...
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                            <div class="form-group">
                                                                <label class="floating-label-activo-sm " for="orientac">Orientación (Describir)</label>
                                                                <select name="orientac" data-titulo="Orientación" data-seccion="Funciones Corticales" id="orientac" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('orientac','div_orientac','obs_orientac',2);">
                                                                    <option value="0">Seleccione</option>
                                                                    <option value="1" data-valor="Orientado en Tiempo y espacio">Orientado en Tiempo y espacio</option>
                                                                    <option value="2" data-valor="Alterado">Alterado (Describir)option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group" id="div_orientac" style="display:none;">
                                                                <label class="floating-label-activo-sm " for="obs_orientac">Obs. Orientacion Alterada (Describir)</label>
                                                        ...
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                            ...
                                                            <div class="form-group" id="div_comport_emoc" style="display:none;">
                                                                <label class="floating-label-activo-sm " for="obs_comport_emoc">Obs.Comportamiento Emocional (Describir)</label>
                                                ...
                                                <div class="tab-pane fade" id="ex_lenguaje" role="tabpanel" aria-labelledby="ex_lenguaje-tab">
                                                    <div class="form-row">
                                                        <div class="col-sm-12 col-md-12">
                                                            <h6 class="f-16 text-dark mb-3">Características</h6>
                                                         </div>
                                                        <div class="col-sm-12 col-md-12">
                                                            <div class="form-row">
                                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="l_fluidez" data-titulo="Fluidez" id="l_fluidez" data-seccion="Lenguaje" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('l_fluidez','div_l_fluidez','obs_l_fluidez',2);">
                                                                            <option value="0">Seleccione</option>
                                                                            <option value="1" data-valor="Normal">Normal</option>
                                                                            <option value="2" data-valor="Anormal Describir">Anormal (Describir)</option>
                                                                            <option value="3" data-valor="No Examinada">No Examinada</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group" id="div_l_fluidez" style="display:none;">
                                                                        <label class="floating-label-activo-sm " for="obs_l_fluidez">Alteración (Describir)</label>
                                                                ...
                                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                    ...
                                                                    <div class="form-group" id="div_l_int_vol" style="display:none;">
                                                                        <label class="floating-label-activo-sm " for="obs_l_int_vol">Alteración (Describir)</label>
                                                                ...
                                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                    ...
                                                                    <div class="form-group" id="div_l_artic" style="display:none;">
                                                                        <label class="floating-label-activo-sm " for="obs_l_artic">Alteración (Describir)</label>
                                                                ...
                                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                    ...
                                                                    <div class="form-group" id="div_l_exact" style="display:none;">
                                                                        <label class="floating-label-activo-sm " for="obs_l_exact">Alteración (Describir)</label>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                    ...
                                                                    <div class="form-group" id="div_l_denom_img" style="display:none;">
                                                                        <label class="floating-label-activo-sm " for="obs_l_denom_img">Alteración (Describir)</label>
                                                                ...
                                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="l_repet" data-titulo="Repeticiones" id="l_repet" data-seccion="Lenguaje" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('l_repet','div_l_repet','obs_l_repet',2);">
                                                                            <option value="0">Seleccione</option>
                                                                            <option value="1" data-valor="Normal">Normal</option>
                                                                            <option value="2" data-valor="Anormal">Anormal (Describir)</option>
                                                                            <option value="3" data-valor="No Examinada">No Examinada</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group" id="div_l_repet" style="display:none;">
                                                                        <label class="floating-label-activo-sm " for="obs_l_repet">Alteración (Describir)</label>
                                                                ...
                                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                    ...
                                                                    <div class="form-group" id="div_l_comp_oral" style="display:none;">
                                                                        <label class="floating-label-activo-sm " for="obs_l_comp_oral">Alteración (Describir)</label>
                                                                ...
                                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                    ...
                                                                    <div class="form-group" id="div_l_lec_esc" style="display:none;">
                                                                        <label class="floating-label-activo-sm " for="obs_l_lec_esc">Alteración (Describir)</label>
                                                        ...
                                                        <div class="col-sm-12 col-md-12">
                                                            <h6 class="f-16 text-dark mb-3">Afasias</h6>
                                                         </div>
                                                        <div class="col-sm-12 col-md-12">
                                                            <div class="form-row">
                                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="l_afas" data-titulo="Afasia" id="l_afas" data-seccion="Lenguaje" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('l_afas','div_l_afas','obs_l_afas',2);">
                                                                            <option value="0">Seleccione</option>
                                                                            <option value="1" data-valor="No">No</option>
                                                                            <option value="2" data-valor="Si">Si</option>
                                                                            <option value="3" data-valor="No Examinada">No Examinada</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group" id="div_l_afas" style="display:none;">
                                                                        <label class="floating-label-activo-sm " for="obs_l_afas">Obs.Alteración (Describir)</label>
                                                                ...
                                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="l_af_tipo" data-titulo="Tipos" data-seccion="Lenguaje" id="l_af_tipo" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('l_af_tipo','div_l_af_tipo','obs_l_af_tipo',4);">
                                                                            <option value="0">Seleccione</option>
                                                                            <option value="1" data-valor="Motora">Motora</option>
                                                                            <option value="2" data-valor="Sensitiva">Sensitiva</option>
                                                                            <option value="3" data-valor="Global">Global</option>
                                                                            <option value="4" data-valor="Describir Observaciones">Describir Observaciones</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group" id="div_l_af_tipo" style="display:none;">
                                                                        <label class="floating-label-activo-sm " for="obs_l_af_tipo">Describir (Describir)</label>
                                                        ...
                                                        <div class="col-sm-12 col-md-12">
                                                            <h6 class="f-16 text-dark mb-3">Disartrias</h6>
                                                         </div>
                                                        <div class="col-sm-12 col-md-12">
                                                            <div class="form-row">
                                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                    ...
                                                                    <div class="form-group" id="div_l_disar" style="display:none;">
                                                                        <label class="floating-label-activo-sm " for="obs_l_disar">Describir (Describir)</label>
                                                                ...
                                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                    <div class="form-group">
                                                                        <label class="floating-label-activo-sm " for="l_disar_ot">Otros Tipos (Describir)</label>
                                                        ...
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="m_inmed" data-titulo="Memoria inmediata" data-seccion="Memoria" id="m_inmed" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('m_inmed','div_m_inmed','obs_m_inmed',2);">
                                                                    <option value="0">Seleccione</option>
                                                                    <option value="1" data-valor="Normal">Normal</option>
                                                                    <option value="2" data-valor="Anormal">Anormal</option>
                                                                    <option value="3" data-valor="No Examinado">No Examinado</option>
                                                                </select>
                                                            </div>
                                               ...
                                               <div class="tab-pane fade" id="ex_lobulo_frontal" role="tabpanel" aria-labelledby="ex_lobulo_frontal-tab">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                        <label class="floating-label-activo-sm" for="obs_ex_generales_fc">Obs. Generales Funciones Corticales</label>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="pc_olf" data-titulo="I Olfatorio" data-seccion="Nervios Craneales" id="pc_olf" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('pc_olf','div_pc_olf','obs_pc_olf',2);">
                                                                    <option value="0">Seleccione</option>
                                                                    <option value="1" data-valor="Normales">Normales</option>
                                                                    <option value="2" data-valor="Anormales">Anormales</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group" id="div_pc_olf" style="display:none;">
                                                                <label class="floating-label-activo-sm " for="obs_pc_olf">(Describir)</label>
                                                        ...
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                            ...
                                                            <div class="form-group" id="div_pc_opt" style="display:none;">
                                                                <label class="floating-label-activo-sm " for="obs_pc_opt"> (Describir)</label>
                                                        ...
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                            ...
                                                            <div class="form-group" id="div_pc_ocumot" style="display:none;">
                                                                <label class="floating-label-activo-sm " for="obs_pc_ocumot">(Describir)</label>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                            ...
                                                            <div class="form-group" id="div_pc_troq" style="display:none;">
                                                                <label class="floating-label-activo-sm " for="obs_pc_troq"> (Describir)</label>
                                                        ...
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                            ...
                                                            <div class="form-group" id="div_pc_trig" style="display:none;">
                                                                <label class="floating-label-activo-sm " for="obs_pc_trig">(Describir)</label>
                                                        ...
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="pc_abd" data-titulo="VI.- Abducente" data-seccion="Nervios Craneales" id="pc_abd" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('pc_abd','div_pc_abd','obs_pc_abd',2);">
                                                                    <option value="0">Seleccione</option>
                                                                    <option value="1" data-valor="Claro">Claro</option>
                                                                    <option value="2" data-valor="Anormal">Anormal</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group" id="div_pc_abd" style="display:none;">
                                                                <label class="floating-label-activo-sm " for="obs_pc_abd">(Describir)</label>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                ...
                                                                <div class="form-group" id="div_pc_fac" style="display:none;">
                                                                    <label class="floating-label-activo-sm "for="obs_pc_fac"> (Describir)</label>
                                                            ...
                                                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                ...
                                                                <div class="form-group" id="div_pc_aud" style="display:none;">
                                                                    <label class="floating-label-activo-sm "for="obs_pc_aud">Obs. Audítivo (Describir)</label>
                                                            ...
                                                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                ...
                                                                <div class="form-group" id="div_pc_glof" style="display:none;">
                                                                    <label class="floating-label-activo-sm "for="obs_pc_glof">Obs. Glosofaríngeo (Describir)</label>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                                ...
                                                                <div class="form-group" id="div_pc_vago" style="display:none;">
                                                                    <label class="floating-label-activo-sm "for="obs_pc_vago">Obs. Vago (Describir)</label>
                                            ...
                                            <div class="col-sm-12 col-md-12">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                        <button type="button" class="btn btn-primary-light-c btn-block btn-sm mt-1" onclick="pares();"><i class="feather icon-edit-1"></i> Pares Craneanos</button>
                                                    </div>
                                                    <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                                                        <div class="form-group">
                                                            <label class="floating-label-activo-sm" for="obs_gen_pc">Obs. Pares Craneales</label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_sm_trof_mot" style="display:none;">
                                                        <label class="floating-label-activo-sm " for="obs_sm_trof_mot">Trofismo motor (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_sm_tono" style="display:none;">
                                                        <label class="floating-label-activo-sm " for="obs_sm_tono">Tono (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="sm_fuer" data-titulo="Fuerza" data-seccion="Sistema Motor" id="sm_fuer" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('sm_fuer','div_sm_fuer','obs_sm_fuer',2);">
                                                            <option value="0">Seleccione</option>
                                                            <option value="1" data-valor="Bordes netos y Normales">Bordes netos y Normales</option>
                                                            <option value="2" data-valor="Anormales">Anormales</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group" id="div_sm_fuer" style="display:none;">
                                                        <label class="floating-label-activo-sm " for="obs_sm_fuer">Fuerza (Describir)</label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_sm_r_prof" style="display:none;">
                                                        <label class="floating-label-activo-sm " for="obs_sm_r_prof">Reflejos Profundos (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_sm_r_sup" style="display:none;">
                                                        <label class="floating-label-activo-sm " for="obs_sm_r_sup">Reflejos Superficiales (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_sm_mov_anor" style="display:none;">
                                                        <label class="floating-label-activo-sm " for="obs_sm_mov_anor">Movimientos Anormales (Describir)</label>
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="row mb-2">
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-10">
                                                    <button type="button" class="btn btn-primary-light-c btn-block btn-xxs mt-1" onclick="reflejos();"><i class="feather icon-edit-1"></i> Reflejos Osteotendineos</button>
                                                </div>
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-10">
                                                    <button type="button" class="btn btn-primary-light-c btn-block btn-xxs mt-1" onclick="fuerza_sup();"><i class="feather icon-edit-1"></i>Examen Fuerza extremidad Superior</button>
                                                </div>
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-10">
                                                    <button type="button" class="btn btn-primary-light-c btn-block btn-xxs mt-1" onclick="fuerza_inf();"><i class="feather icon-edit-1"></i> Examen Fuerza extremidad Inferior</button>
                                                </div>
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-10">
                                                    <button type="button" class="btn btn-primary-light-c btn-block btn-xxs mt-1" onclick="postural();"><i class="feather icon-edit-1"></i> Examen motor Postura y Marcha</button>
                                                </div>
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-10">
                                                    <button type="button" class="btn btn-primary-light-c btn-block btn-xxs mt-1" onclick="tono();"><i class="feather icon-edit-1"></i> Examen Nervios Motores</button>
                                                </div>
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-10">
                                                    <button type="button" class="btn btn-primary-light-c btn-block btn-xxs mt-1" onclick="sensibilidad();"><i class="feather icon-edit-1"></i> Examen Nervios Sensitivos</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                    ...
                                                    <div class="form-group" id="div_ss_dolor" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="obs_ss_dolor">Dolor (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                    ...
                                                    <div class="form-group" id="div_ss_tact_gr" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="obs_ss_tact_gr">Tacto Grueso (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                    ...
                                                    <div class="form-group" id="div_ss_sen_disc" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="obs_ss_sen_disc">Sensibilidad discriminativa (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                    ...
                                                    <div class="form-group" id="div_ss_calor" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="obs_ss_calor">Calor (Describir)</label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                    ...
                                                    <div class="form-group" id="div_ss_sen_vib" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="obs_ss_sen_vib">Sensibilidad vibratoria (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                    ...
                                                    <div class="form-group" id="div_ss_sen_pos" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="obs_ss_sen_pos">Sensibilidad posicional (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                    ...
                                                    <div class="form-group" id="div_ss_estereog" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="ss_obs_ss_estereog">Estereognosias (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="ss_grafest" data-titulo="Grafestesia" data-seccion="Sistema Sensitivo" id="ss_grafest" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('ss_grafest','div_ss_grafest','obs_ss_grafest',2);">
                                                            <option value="0">Seleccione</option>
                                                            <option value="1" data-valor="Sana">Sana</option>
                                                            <option value="2" data-valor="Anormal">Anormal</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group" id="div_ss_grafest" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="ss_obs_ss_grafest">Grafestesia (Describir)</label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_cer_dism" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="obs_cer_dism">Dismetría (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_cer_temb" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="obs_cer_temb">Temblor  (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_cer_diado" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="obs_cer_diado">Diadococinesia (Describir)</label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_cer_atax" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="obs_cer_atax">Ataxia  (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_cer_rig" style="display:none;">
                                                        <label class="floating-label-activo-sm "for="obs_cer_rig">Rigidez (Describir)</label>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-12">
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 p-10 m-9" >
                                                    <h6 class="f-16 mb-2 text-dark">Examen Postural</h6>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    ...
                                                    <div class="form-group" id="div_post_tono" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_tono">Tono Postural (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    ...
                                                    <div class="form-group" id="div_post_epost" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_epost">Estabilidad Postural (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    ...
                                                    <div class="form-group" id="div_post_p_pie" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_p_pie">Posición de pie (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    ...
                                                    <div class="form-group" id="div_post_romb" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_romb">Romberg (Describir)</label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 p-10 m-9">
                                                    <h6 class="f-16 mb-2 text-dark">Examen Marcha</h6>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_post_mar_ini" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_mar_ini">Inicio de la Marcha (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_post_mar_gir" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_mar_gir">Giros (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_post_mar_at" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_mar_at">Marcha atrás (Describir)</label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_post_mar_punt" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_mar_punt">Marcha puntillas (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_post_mar_st" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_mar_st">Sobre Talón (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_post_mar_tp" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_mar_tp">Talón-punta  (Describir)</label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_post_mar_ampl" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_mar_ampl">Amplitud de la Marcha  (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_post_mar_bs" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_mar_bs">Base sustentación  (Describir)</label>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    ...
                                                    <div class="form-group" id="div_post_mar_brac" style="display:none;">
                                                        <label class="floating-label-activo-sm" for="obs_post_mar_brac">Braceo (Describir)</label>
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                            ...
                                            <div class="form-group" id="div_im_rnuc" style="display:none;">
                                                <label class="floating-label-activo-sm" for="obs_im_rnuc">Rigidez de Nuca (Describir)</label>
                                        ...
                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                            ...
                                            <div class="form-group" id="div_im_s_ker" style="display:none;">
                                                <label class="floating-label-activo-sm" for="obs_im_s_ker">S. de Kerning (Describir)</label>
                                        ...
                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                            ...
                                            <div class="form-group" id="div_im_s_bru" style="display:none;">
                                                <label class="floating-label-activo-sm" for="obs_im_s_bru">S. de Brudzinski (Describir)</label>
...
<script>
// Función original restaurada - funciona con valores numéricos
function evaluar_para_carga_detalle(select, div, input, valor) {
    var valor_select = $('#' + select).val();
    if (valor_select == valor) {
        $('#' + div).show();
    } else {
        $('#' + div).hide();
        $('#' + input).val('');
