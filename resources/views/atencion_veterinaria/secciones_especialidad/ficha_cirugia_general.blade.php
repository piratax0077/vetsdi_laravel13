<style>
    ...
    #cirugia-avisos .alert-atencion {
        width: 100%;
        margin-bottom: .35rem;
        transition: opacity .45s ease;
    }

    #cirugia-avisos .alert-atencion.aviso-saliendo {
        opacity: 0;
    }
</style>
    ...
    <div class="col-md-12 py-0 px-2 shadow-none">
        <div class="row mx-0">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <ul class="nav nav-tabs-secciones mb-3 mt-3" id="cirugia-tabs" role="tablist">
           ...
           <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="form-row mb-1" id="cirugia-avisos">
...
@section('page-script-ficha-atencion')
    <script>
        ...
        console.log('dropzone probando');
        /** MANEJO DE IMAGENES */
        var myDropzone_eda ;
        Dropzone.options.misArchivosHosp = {
            init:function()
            {
                myDropzone_eda = this;
            },
