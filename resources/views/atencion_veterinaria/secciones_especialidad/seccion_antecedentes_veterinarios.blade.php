        ...
        <div id="cgc-c" class="collapse show" aria-labelledby="cgc" data-parent="#cgc">
            <div class="card-body-aten-a">
                <div class="row">
                    ...
                    {{-- Vacunación y desparasitación veterinaria --}}
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input"
                                            id="abrir_vacunacion_desparasitacion"
                                            onchange="if (this.checked) { abrirVacunacionVeterinaria(); } else { cerrarVacunacionVeterinaria(); }">
                                        <label class="custom-control-label" for="abrir_vacunacion_desparasitacion"
                                            onclick="setTimeout(function () { var control = document.getElementById('abrir_vacunacion_desparasitacion'); if (control && control.checked) abrirVacunacionVeterinaria(); }, 0)">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3">
                                    <ul class="nav nav-tabs-aten nav-fill" id="orl_adulto" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link-aten text-reset" id="obes-hist-tab" data-toggle="tab" href="#obes-hist" onclick="ver_control_obesidad()" role="tab" aria-controls="obes-hist" aria-selected="true">Historial de controles</a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="tab-content" id="orl_adulto">
                                        ...
                                        <div class="tab-pane fade show active" id="obes-ctrl" role="tabpanel" aria-labelledby="obes-ctrl-tab">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                                    ...
                                                    <input type="number" step="0.01" min="0.01" class="form-control form-control-sm" name="registro_peso" id="registro_peso">
                                                </div>
                                                <div class="form-group col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                                    <label class="floating-label-activo-sm" for="registro_peso_variacion">Variación</label>
                                                    <input type="number" step="0.01" class="form-control form-control-sm" name="registro_peso_variacion" id="registro_peso_variacion">
                                                </div>
                                                <div class="form-group col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                                    <label class="floating-label-activo-sm" for="registro_peso_ideal">Peso Ideal</label>
                                                    <input type="number" step="0.01" min="0.01" class="form-control form-control-sm" name="registro_peso_ideal" id="registro_peso_ideal">
                                                </div>
                                                <div class="form-group col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                        ...
                                        <div class="tab-pane fade show" id="obes-hist" role="tabpanel" aria-labelledby="obes-hist-tab">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <table id="control_obesidad" class="table table-bordered table-sm">
                                                        <thead>
                                                            <tr>
                                                                <th>N.º control</th>
                                                                <th>Fecha</th>
                                                        ...
                                                        <tbody><tr><td colspan="5" class="text-center">Sin controles registrados.</td></tr></tbody>
                                                    </table>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card-informacion">
                                                        <div class="card-body">
                                                            <div id="contenedor_grafico_variacion_peso_controles" style="min-height: 280px; position: relative;">
    ...
    <div class="modal-dialog modal-lg  modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="modal-title text-white">Añadir patologías crónicas</h5>
                        <input type="hidden" id="nuevo_antecedente" name="nuevo_antecedente" value="1">
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function ()
    {
        ...
        /** Abrir ficha sanitaria de la mascota. */
        $('#abrir_vacunacion_desparasitacion').change(function() {
            if ($(this).is(':checked')) {
                $('#modal_vacunacion_desparasitacion').modal('show');
            } else {
                $('#modal_vacunacion_desparasitacion').modal('hide');
            }
        });
    ...
    {
        const peso = $('#registro_peso').val();
        const variacion = $('#registro_peso_variacion').val();
        const ideal = $('#registro_peso_ideal').val();
        const $boton = $('#obes-ctrl button[onclick="registrar_control_obesidad();"]');

        if (peso === '' || variacion === '' || ideal === '') {
            swal({
                title: 'Datos incompletos',
                text: 'Ingrese peso, variación y peso ideal.',
                icon: 'warning'
            });
            return;
        }
        ...
        $.ajax({
            url: "{{ route('control_obesidad.store') }}",
            type: 'POST',
            data: {
                _token: CSRF_TOKEN,
                id_ficha_atencion: $('#id_fc').val(),
                id_paciente: $('#id_paciente_fc').val(),
                id_mascota: $('#id_mascota_fc').val(),
                peso: peso,
                variacion: variacion,
                ideal: ideal
            }
        }).done(function (response) {
            if (parseInt(response.estado || 0, 10) !== 1) {
                swal({
                    title: 'Error al guardar',
                    text: response.msj || 'No fue posible guardar el control.',
                    icon: 'error'
                });
                return;
            }
            ...
            ver_control_obesidad(true);
        }).fail(function (xhr) {
            const errores = xhr.responseJSON && xhr.responseJSON.errors
                ? Object.values(xhr.responseJSON.errors).flat().join('\n')
                : (xhr.responseJSON && xhr.responseJSON.message) || 'No fue posible guardar el control.';
            swal({ title: 'Error al guardar', text: errores, icon: 'error' });
        }).always(function () {
            ...
            if (data !== 'null')
            {
                ...
                if(data.estado == 1)
                {
                    $.each(data.registros, function(index, value)
                    {
                        ...
                        {
                            html += '        <input type="checkbox" data-id="'+value.id+'" data-control="'+value.id_tipo_control+'" class="btn_agregar_medicamento" name="medicamento_cronico_'+tipo_enfermedad+'[]" id="medicamento_cronico_'+tipo_enfermedad+'_'+value.id+'" onchange="agregar_medicamento_cronico_a_receta(this, \''+tipo_enfermedad+'\')">';
                        }
                        else
                        {
    ...
    function ver_control_obesidad(abrirHistorial = false)
    {
        $('#control_obesidad tbody').html('<tr><td colspan="5" class="text-center">Cargando controles...</td></tr>');

        $.ajax({
            url: "{{ route('control_obesidad.getControlObesidad') }}",
            type: 'GET',
            data: {
                _token: CSRF_TOKEN,
                id_paciente: $('#id_paciente_fc').val(),
            ...
            registros.forEach(function (registro, index) {
                const fecha = registro.created_at ? new Date(registro.created_at).toLocaleDateString('es-CL') : '-';
                html += '<tr>';
                html += '<td>' + (index + 1) + '</td>';
                html += '<td>' + fecha + '</td>';
                html += '<td>' + Number(registro.peso).toLocaleString('es-CL') + ' kg</td>';
                html += '<td>' + Number(registro.variacion).toLocaleString('es-CL') + ' kg</td>';
                html += '<td>' + Number(registro.ideal).toLocaleString('es-CL') + ' kg</td>';
                html += '</tr>';
            });

            if (registros.length === 0) {
                html = '<tr><td colspan="5" class="text-center">Sin controles registrados para esta mascota.</td></tr>';
            }

            $('#control_obesidad tbody').html(html);
            renderizar_grafico_variacion_obesidad(registros);

            if (abrirHistorial) {
                $('#obes-hist-tab').tab('show');
            }
        }).fail(function () {
            $('#control_obesidad tbody').html('<tr><td colspan="5" class="text-center text-danger">No fue posible cargar los controles.</td></tr>');
            renderizar_grafico_variacion_obesidad([]);
        });
    }

    function renderizar_grafico_variacion_obesidad(registros)
    {
        ...
        if (!canvas || typeof Chart === 'undefined' || registros.length === 0) {
            return;
        }

        const etiquetas = registros.map(function (registro, index) {
            const fecha = registro.created_at ? new Date(registro.created_at).toLocaleDateString('es-CL') : '';
            return 'Control ' + (index + 1) + (fecha ? ' · ' + fecha : '');
        });

        window.graficoPesoInstance = new Chart(canvas.getContext('2d'), {
            type: 'line',
            data: {
                labels: etiquetas,
                datasets: [
                    {
                        ...
                        data: registros.map(function (r) { return Number(r.peso); }),
                        borderColor: '#12aeb2',
                        backgroundColor: 'rgba(18, 174, 178, 0.12)',
                        fill: false,
                        lineTension: 0.25
                    },
                    {
                        label: 'Peso ideal (kg)',
                        data: registros.map(function (r) { return Number(r.ideal); }),
                        borderColor: '#75429a',
                        backgroundColor: 'rgba(117, 66, 154, 0.10)',
                        borderDash: [6, 4],
                        fill: false,
                        lineTension: 0.2
                    },
                    {
                        label: 'Variación (kg)',
                        data: registros.map(function (r) { return Number(r.variacion); }),
                        borderColor: '#ff6b6b',
            ...
            options: {
                ...
                title: { display: true, text: 'Variación del peso de la mascota' },
                scales: {
                    yAxes: [{
                        ticks: { beginAtZero: false },
                        scaleLabel: { display: true, labelString: 'Kilogramos' }
                    }]
                }
            }
        });
    ...
    function ver_control_diabetes()
    {
        ...
        .done(function(data)
        {
            ...
            if (data !== 'null')
            {
                ...
                console.log('atencion_medica.secciones_especialidad.seccion_antecedentes_veterinarios');
                console.log(data);
                console.log('-----------------------');
                var html = '';
                if(data.estado == 1)
    ...
    function agregar_medicamento_cronico_a_receta(checkbox, tipo)
    {
        if (!checkbox.checked) {
            return;
        }
        ...
        agregar_a_receta(tipo, [$(checkbox).attr('data-id')], checkbox);
    }

    function agregar_a_receta(tipo, medicamentosSeleccionados, checkboxOrigen)
    {
        var lista_medicamentos_a_receta = Array.isArray(medicamentosSeleccionados)
        ...
        if(lista_medicamentos_a_receta.length > 0)
        {
            ...
            .done(function(resp) {
                ...
                if(resp.estado == 1)
                {
                    var mensaje = resp.msj || 'Medicamento agregado a la receta veterinaria.';
                    swal({
                    ...
                    if (checkboxOrigen) {
                        checkboxOrigen.checked = true;
                        checkboxOrigen.disabled = true;
                        checkboxOrigen.title = 'Agregado a la receta veterinaria';
                    }

                    if (typeof ver_medicamento_ficha_medica_sdi === 'function') {
                ...
                else
                {
                    ...
                    if (checkboxOrigen) {
                        checkboxOrigen.checked = false;
                        checkboxOrigen.disabled = false;
                    }
                }
            })
            .fail(function(jqXHR, ajaxOptions, thrownError) {
                ...
                swal({
                    title: 'Receta veterinaria',
                    text: 'No fue posible agregar el medicamento. Intente nuevamente.',
                    icon: 'error'
                });
            });
        }
        ...
        {
            swal({
                title: "Debe seleccionar al menos un medicamento para ingresar a la receta veterinaria.",
                icon: "warning",
            });
        }
    }
    ...
    function restablecerInterruptor(selector)
    {
        $(selector).prop('checked', false);
    }

    $(document)
        .on('hide.bs.modal hidden.bs.modal', '#m_agregar_antecedente', function () {
            restablecerInterruptor('#check_antecedentes');
        })
        .on('hide.bs.modal hidden.bs.modal', '#form_enfermedad_cronica', function () {
            restablecerInterruptor('#enf_cronico');
        })
        .on('hide.bs.modal hidden.bs.modal', '#modal_vacunacion_desparasitacion', function () {
            restablecerInterruptor('#abrir_vacunacion_desparasitacion');
        })
        .on('click', '#m_agregar_antecedente .close, #m_agregar_antecedente [data-dismiss="modal"], #m_agregar_antecedente [data-bs-dismiss="modal"]', function () {
            restablecerInterruptor('#check_antecedentes');
        })
        .on('click', '#form_enfermedad_cronica .close, #form_enfermedad_cronica [data-dismiss="modal"], #form_enfermedad_cronica [data-bs-dismiss="modal"]', function () {
            restablecerInterruptor('#enf_cronico');
        })
        .on('click', '#modal_vacunacion_desparasitacion .close, #modal_vacunacion_desparasitacion [data-dismiss="modal"], #modal_vacunacion_desparasitacion [data-bs-dismiss="modal"]', function () {
            restablecerInterruptor('#abrir_vacunacion_desparasitacion');
        });
    ...
    function cambiar_antecedente()
    {
        ...
        {
            var nombre_enfermedad = 'Patologías Crónicas';
            ...
            switch(tipo)
            {
                ...
                case '1':
                    html+=`
                        <table class="display table table-borderless  dt-responsive nowrap pb-4 table-sm" style="width:100%">
                            <tr>
                                <td class="f-16 font-weight-bold">Patología crónica</td>
                                <td>
                                    <select class="form-control" id="nombre">
                                        <option value="">Seleccione una patología crónica</option>
                                        @foreach (\App\Models\EnfermedadCronica::query()->orderBy('Nombre')->get(['id', 'Nombre']) as $patologiaCronica)
                                            <option value="{{ $patologiaCronica->Nombre }}" data-id="{{ $patologiaCronica->id }}">{{ $patologiaCronica->Nombre }}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
    ...
    const agregarAntecedente = () => {
        ...
        data.nombre_enfermedad_cronica = $('#nombre').val();
        data.id_enfermedad_cronica = $('#nombre option:selected').data('id') || '';
        ...
        $.ajax({
            ...
            success: (resp)=>{
                ...
                if(resp.estado==1)
                {
                    ...
                    $('#tabla_antecedentes_modal thead').html(`
                        <tr>
                            <th>Patología crónica</th>
                            <th>Comentario</th>
                            <th>Profesional</th>
                            <th>Fecha</th>
                            <th></th>
                    ...
                    `);
                    $('#tabla_antecedentes_modal tbody').html(`
                        <tr>
                            <td colspan="5" class="text-center text-muted">No hay patologías crónicas registradas.</td>
                        </tr>
                    `);
                    $('#listado_patologias_paciente').empty();
                }
