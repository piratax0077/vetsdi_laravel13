<div class="container-fluid bg-c-blue" style="position:absolute;">
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-3 text-white text-center">
            <img class="wid-145 py-5" src="{{ url('/images/logo.png') }}">
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 text-center">
            <img class="wid-145 py-5" src="{{ url('/images/logo_pais.png') }}">
        </div>
    ...
    <div class="row">
        <div class="col-md-12 bg-light text-center text-c-blue">
            <p style="margin-bottom: 6px; margin-top: 6px; font-size: 12px;">Copyright © 2021 SALUD DIGITAL INTEGRADA EN
                CHILE SOMOS <b>MEDICHILE</b>
            </p>
        </div>
    </div>
</div>
