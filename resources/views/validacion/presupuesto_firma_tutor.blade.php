...
<head>
    ...
    <title>Validación de firma del tutor</title>
    <style>
        * { box-sizing: border-box; }
        ...
        .card {
            ...
            background: #fff;
            border-radius: 16px;
            box-shadow: 0 14px 40px rgba(32, 61, 74, .14);
        }
...
<body>
    <main class="card">
        <header class="header">
            ...
            <p>Validación de firma electrónica</p>
        </header>
        <section class="body">
            <div class="ok">Firma del tutor válida y documento auténtico.</div>
            <div class="grid">
                <div class="item">
            ...
            <a class="btn" href="{{ asset($documento->url) }}" target="_blank">Ver presupuesto firmado</a>
        </section>
    </main>
</body>
</html>
