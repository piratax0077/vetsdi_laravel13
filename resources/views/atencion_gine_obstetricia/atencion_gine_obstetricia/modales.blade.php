    ...
    <div class="col-sm-12">
        <div class="boton-formularios">
            ...
            <div class="redes">
                ...
                @if($profesional->SubTipoEspecialidad()->first()->nombre == 'Ginecologia y Obtetricia General' )
                <a id="boton_3" class="fas fa-female fa-2x" data-toggle="canvas" data-target="#formularios_gine_obstetricia" aria-expanded="false" aria-controls="bs-canvas-right" title="Formularios Gineco_obstétricos" data-placement="left"></a>
            @endif
            </div>
            <div class="btn-mas">
