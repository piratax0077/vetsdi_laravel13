    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
             <div class="modal-header bg-info">
                <h5 class="modal-title text-white mt-1 f-20 text-center" id="modal_info1"> Calculadora gestacional</h5>
             ...
             <div class="modal-body">
                <!--<div class="row">
                    <div class="col-sm-12 col-md-12 text-center">
                        <h4 class="text-c-blue">Calculadora gestacional</h4>
                        <hr>
                    </div>
                </div>-->
                <div class="row mx-1">
                    <div class="col-sm-8 col-md-8">
                        ...
                        <div class="row border rounded py-3 mb-3 mr-1">
                            <div class="col-sm-12 col-md-12">
                                <h5 class="mb-3 text-c-blue">PESO FETAL ESTIMADO Y PERCENTIL <span id="sdgesta">(3+2 sg)</span></h5>
                            </div>
                            <div class="col-sm-12 col-md-12">
                                <div class="input-group input-group-sm">
                                  <input type="number" class="form-control" id="pfe3" placeholder="Peso fetal estimado">
                                  <div class="input-group-append">
                                    <span class="input-group-text" id="percentilA">P __</span>
                                  </div>
                                  <button class="btn btn-primary btn-sm ml-3" type="button" onclick="calcPercentil()">Calcula</button>
                                    <!-- Trigger the modal with a button -->
                                    <button type="button" class="btn btn-secondary btn-sm ml-3" data-toggle="modal" data-target="#myModal">Biometrías</button>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12">
                                <p class="mb-1 mt-3">Sexo fetal</p>
                            </div>
                            <div class="col-sm-12 col-md-12">
                        ...
                        <!--Doppler fetal-->
                        <div class="row border rounded mb-3 mr-1 py-3">
                            <div class="col-sm-12 col-md-12">
                                <h5 class="mb-3 text-c-blue">DOPPLER FETAL <span id="sdgesta2">(3+2 sg)</span></h5>
                            </div>
                            <div class="col-sm-6 col-md-6">
                                <label for="ipAU">IP A. Umbilical</label>
                                <div class="input-group input-group-sm mb-2">
                                    <input type="number" class="form-control form-control-sm border" id="ipAU" placeholder="IP Umb" value="">
                                    <div class="input-group-append">
                            ...
                            <div class="col-sm-6 col-md-6">
                                ...
                                <div class="input-group input-group-sm mb-2">
                                    <input type="number" class="form-control form-control-sm border" id="ipACM" placeholder="IP ACM" value="">
                                    <div class="input-group-append">
                            ...
                            <div class="col-sm-6 col-md-6">
                                ...
                                <div class="input-group input-group-sm mb-2">
                                    <input type="number" class="form-control form-control-sm border" id="ICP" placeholder="ICP" value="">
                                    <div class="input-group-append">
                                        <span class="input-group-text" id="ICPtx">P __</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-6">
                                ...
                                <div class="input-group input-group-sm mb-2">
                                    <input type="number" class="form-control form-control-sm border" id="velACM" placeholder="V. máx ACM" value="">
                                    <div class="input-group-append">
                            ...
                            <div class="col-sm-6 col-md-6">
                                ...
                                <div class="input-group input-group-sm mb-2">
                                    <input type="number" class="form-control form-control-sm border" id="ipDV" placeholder="IP DV" value="">
                                    <div class="input-group-append">
                                        <span class="input-group-text" id="ipDVtx">P __</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 align-self-end text-right mb-2">
                                <!--<button type="button" class="btn btn-secondary mt-2" data-toggle="modal" data-target="#ModalRefDoppler">Referencias</button>-->
                                <button class="btn btn-primary btn-sm btn-block mt-2 ml-2" type="button" onclick="dopplerFetal()">Calcular</button>
                            </div>
                        </div>
                        <!--Doppler de arterias uterinas-->
                        <div class="row border rounded mr-1 py-3">
                            <div class="col-sm-12 col-md-12">
                                <h5 class="mb-3 text-c-blue">DOPPLER DE ARTERIAS UTERINAS <span id="sdgesta3">(3+2 sg)</span></h5>
                            </div>
                            <div class="col-sm-6 col-md-6 mb-2">
                                <label for="uterinaE">Uterina izquierda (IP)</label>
                                <input type="number" class="form-control form-control-sm" id="uterinaE" value="" placeholder="IP" onchange="mitjanaUterines()">
                            </div>
                            <div class="col-sm-6 col-md-6 mb-2">
                                <label for="uterinaD">Uterina derecha (IP)</label>
                                <input type="number" class="form-control form-control-sm" id="uterinaD" value="" placeholder="IP" onchange="mitjanaUterines()">
                            </div>
                            <div class="col-sm-6 col-md-6">
                                <label for="mitjaUt">IP medio de arterias uterinas</label>
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control form-control-sm border" id="mitjaUt" aria-label="Media de arterias uterinas" placeholder="IP medio" readonly="">
                                    <div class="input-group-append">
                            ...
                            <div class="col-sm-6 col-md-6 mt-2">
                                <label></label>
                                <button type="button" class="btn btn-primary btn-sm btn-block" onclick="mitjanaUterines()">Calcular</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-md-4">
                        ...
                        <div class="row border rounded py-3 mb-3">
                            <div class="col-md-12">
                                <h5 class="text-c-blue">EDAD GESTACIONAL</h5>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="number" class="form-control form-control-sm border" id="setmanes" placeholder="semanas" value="" onchange="datamanual()">
                            </div>
                            <div class="col-md-6 mt-3">
                                <label for="dies">
                                    <h6>Días</h6>
                                </label>
                                <input type="number" class="form-control form-control-sm border" id="dies" placeholder="días" value="" onchange="datamanual()">
                            </div>
                        </div>
                        <!--Primer trimestre-->
                        <div class="row border rounded py-3">
                            <div class="col-md-12">
                                <h5 class="text-c-blue">PRIMER TRIMESTRE</h5>
                            </div>
                            <div class="col-md-12 mb-3">
                                <h6>CRL <span id="crl_fur">(FUR corregida: 2022-02-13)</span></h6>
                                <div class="input-group input-group-sm">
                                    <input type="number" class="form-control form-control-sm border" id="crl" placeholder="CRL" value="">
                                    <div class="input-group-append">
                            ...
                            <div class="col-md-12">
                                <h6>TN</h6>
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm border" id="tn" readonly="">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 mt-2">
                                <!--<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#ModalRefPrimer">Referencias</button>-->
                                <button class="btn btn-primary btn-sm btn-block" type="button" onclick="calcPrimer()">Calcular</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Calcula el peso fetal estimado</h5>
            ...
            <div class="modal-body">
                <div class="input-group input-group-sm">
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control form-control-sm" id="DBP" onchange="pesEstimat2()">
                    </div>
                    <div class="col-md-3">
                        <label for="PC">CC:</label>
                        <input type="number" class="form-control form-control-sm" id="PC" onchange="pesEstimat2()">
                    </div>
                    <div class="col-md-3">
                        <label for="PA">PA:</label>
                        <input type="number" class="form-control form-control-sm" id="PA" onchange="pesEstimat2()">
                    </div>
                    <div class="col-md-3">
                        <label for="LF">LF:</label>
                        <input type="number" class="form-control form-control-sm" id="LF" onchange="pesEstimat2()">
                    </div>
                    <div class="col-md-9 mb-3 mt-3">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" class="form-control form-control-sm" aria-label="Peso fetal estimado" id="pfe2" readonly="">
                            <div class="input-group-append">
                    ...
                    <div class="col-md-3 mb-3 mt-3">
                        <button type="button" class="btn btn-primary  btn-sm btn-block" onclick="pesEstimat2()">Calcula</button>
                    </div>
                </div>
            </div>
