<div id="m_rx_pie" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="m_rx_pie" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white mt-1" id="modal_indicar_examen">Indicar Estudio del Pié</h5>
                             ...
                             <div class="form-group fill">
                                ...
                                <select class="form-control form-control-sm" name="trauma_ped_rxpie" id="trauma_ped_rxpie">
                                    ...
                                    <optgroup label="RX SIMPLE">
                                        <option value="401054">ESTUDIO RX DEL PIÉ</option>
                                    </optgroup>
                                    <optgroup label="COMPLEJAS">
                                        <option value="405028">RESONANCIA MAGNETICA DE PIE</option>
                                        <option value="404016">ECOGRAFIA PARTES BLANDAS DEL PIÉ</option>
                                    </optgroup>
                                </select>
                            </div>
                        </div>
