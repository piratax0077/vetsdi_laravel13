                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <label class="floating-label">Exámenes</label>
                                                <input type="text" class="form-control form-control-sm" name="nombre_acompañante" id="nombre_acompañante">
                                            </div>
                                            ...
                                            <div class="form-group col-md-12">
                                                <label class="floating-label">Diagnóstico Preparto</label>
                                                <input type="text" class="form-control form-control-sm" name="nombre_acompañante" id="nombre_acompañante">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-body"><H5>ANTECEDENTES PARTO</H5>
                                    <div class="col-sm-12">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label class="floating-label">Incidentes en anestésia</label>
                                                <input type="text" class="form-control form-control-sm" name="incidentes_anest" id="incidentes_anest">
                                            </div>
                                            <div class="form-group col-md-4">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label class="floating-label">Otras Observaciones</label>
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group fill">
                                                                                <label class="floating-label">Sin Lat&iacute;do CF</label>
                                                                                <input type="text" class="form-control form-control-sm" id="sin_lat" >
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group fill">
                                                                                <label class="floating-label">Mec&oacute;nio</label>
                                                                                <input type="text" class="form-control form-control-sm" id="meconio" >
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                            <div class="form-group fill">
                                                                                <label class="floating-label">Observaci&oacute;nes</label>
