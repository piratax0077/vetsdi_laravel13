...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="{{ asset('css/estilo_prueba.css') }}" media="screen" />

		<title>Periodontograma</title>
		<script src="{{ asset('js/jquery-3.6.0.min.js') }}"></script>
		<script src="{{asset('js/prueba/getElementsByAttribute.js')}}"></script>
...
<body>
	<div id="contenido">
		<div style="display:none">
			<img src="{{ asset('img_pruebas/cuadrado.png') }}"/>
			<img src="{{ asset('img_pruebas/lleno.png') }}" />
			<img src="{{ asset('img_pruebas/mediolleno.png') }}" />
			<img src="{{ asset('img_pruebas/vacio.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-18.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-17.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-16.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-15.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-14.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-13.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-12.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-11.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-18.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-17.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-16.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-15.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-14.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-13.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-12.png') }}" />
			<img src="{{ asset('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-11.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-21.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-22.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-23.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-24.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-25.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-26.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-27.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-28.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-21.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-22.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-23.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-24.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-25.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-26.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-27.png') }}" />
			<img src="{{ asset('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-28.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-18b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-17b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-16b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-15b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-14b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-13b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-12b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-11b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-18b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-17b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-16b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-15b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-14b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-13b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-12b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-11b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-21b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-22b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-23b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-24b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-25b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-26b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-27b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-28b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-21b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-22b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-23b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-24b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-25b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-26b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-27b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-28b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-48.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-47.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-46.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-45.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-44.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-43.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-42.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-41.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-48.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-47.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-46.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-45.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-44.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-43.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-42.png') }}" />
			<img src="{{ asset('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-41.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-38.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-37.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-36.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-35.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-34.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-33.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-32.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-31.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-38.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-37.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-36.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-35.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-34.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-33.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-32.png') }}" />
			<img src="{{ asset('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-31.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-48b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-47b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-46b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-45b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-44b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-43b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-42b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-41b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-48b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-47b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-46b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-45b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-44b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-43b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-42b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-41b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-38b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-37b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-36b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-35b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-34b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-33b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-32b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-31b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-38b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-37b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-36b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-35b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-34b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-33b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-32b.png') }}" />
			<img src="{{ asset('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-31b.png') }}" />
		</div>
		<div id="wrapper">
			<table id="superior">
				<tr>
...
$('#s18-a').toggle(
	  ...
	  function () {
        $(this).css({"background":"url('img_pruebas/sangrado-supuracion.png')"});
      },
      function () {
...
$('#p38b-c').toggle(
	...
	$('#d18').toggle(
      function () {
        $('#diente18-a').css("background","url('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-18.png')");
		...
		$('#diente18b-a').css("background","url('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-18b.png')");
      ...
      function () {
	  	$('#diente18-a').css("background","url('img_pruebas/tabla1/periodontograma-dientes-arriba-18.png')");
		$('#diente18-a').css("background-position","0 -2px");
		$('#diente18-a').css("background-repeat","no-repeat");
		...
		$('#diente18b-a').css("background","url('img_pruebas/tabla3/periodontograma-dientes-arriba-18b.png')");
		$('#diente18b-a').css("background-position","0 23px");
		$('#diente18b-a').css("background-repeat","no-repeat");
	...
	$('#d17').toggle(
      function () {
        $('#diente17-a').css("background","url('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-17.png')");
		...
		$('#diente17b-a').css("background","url('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-17b.png')");
      ...
      function () {
		$('#diente17-a').css("background","url('img_pruebas/tabla1/periodontograma-dientes-arriba-17.png')");
		$('#diente17-a').css("background-position","0 -2px");
		$('#diente17-a').css("background-repeat","no-repeat");
		...
		$('#diente17b-a').css("background","url('img_pruebas/tabla3/periodontograma-dientes-arriba-17b.png')");
		$('#diente17b-a').css("background-position","0 24px");
		$('#diente17b-a').css("background-repeat","no-repeat");
	...
	$('#d16').toggle(
      function () {
        $('#diente16-a').css("background","url('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-16.png')");
		...
		$('#diente16b-a').css("background","url('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-16b.png')");
      ...
      function () {
		$('#diente16-a').css("background","url('img_pruebas/tabla1/periodontograma-dientes-arriba-16.png')");
		$('#diente16-a').css("background-position","0 4px");
		$('#diente16-a').css("background-repeat","no-repeat");
		...
		$('#diente16b-a').css("background","url('img_pruebas/tabla3/periodontograma-dientes-arriba-16b.png')");
		$('#diente16b-a').css("background-position","0 22px");
		$('#diente16b-a').css("background-repeat","no-repeat");
	...
	$('#d15').toggle(
      function () {
        $('#diente15-a').css("background","url('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-15.png')");
		...
		$('#diente15b-a').css("background","url('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-15b.png')");
      ...
      function () {
		$('#diente15-a').css("background","url('img_pruebas/tabla1/periodontograma-dientes-arriba-15.png')");
		$('#diente15-a').css("background-position","0 5px");
		$('#diente15-a').css("background-repeat","no-repeat");
		...
		$('#diente15b-a').css("background","url('img_pruebas/tabla3/periodontograma-dientes-arriba-15b.png')");
		$('#diente15b-a').css("background-position","0 17px");
		$('#diente15b-a').css("background-repeat","no-repeat");
	...
	$('#d14').toggle(
      function () {
        $('#diente14-a').css("background","url('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-14.png')");
		...
		$('#diente14b-a').css("background","url('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-14b.png')");
      ...
      function () {
		$('#diente14-a').css("background","url('img_pruebas/tabla1/periodontograma-dientes-arriba-14.png')");
		/*$('#diente14-a').css("background-position","0 -2px");*/
		$('#diente14-a').css("background-repeat","no-repeat");
		...
		$('#diente14b-a').css("background","url('img_pruebas/tabla3/periodontograma-dientes-arriba-14b.png')");
		$('#diente14b-a').css("background-position","0 17px");
		$('#diente14b-a').css("background-repeat","no-repeat");
	...
	$('#d13').toggle(
      function () {
        $('#diente13-a').css("background","url('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-13.png')");
		...
		$('#diente13b-a').css("background","url('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-13b.png')");
      ...
      function () {
		$('#diente13-a').css("background","url('img_pruebas/tabla1/periodontograma-dientes-arriba-13.png')");
		$('#diente13-a').css("background-position","top");
		$('#diente13-a').css("background-repeat","no-repeat");
		...
		$('#diente13b-a').css("background","url('img_pruebas/tabla3/periodontograma-dientes-arriba-13b.png')");
		$('#diente13b-a').css("background-position","0 16px");
		$('#diente13b-a').css("background-repeat","no-repeat");
	...
	$('#d12').toggle(
      function () {
        $('#diente12-a').css("background","url('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-12.png')");
		...
		$('#diente12b-a').css("background","url('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-12b.png')");
      ...
      function () {
		$('#diente12-a').css("background","url('img_pruebas/tabla1/periodontograma-dientes-arriba-12.png')");
		$('#diente12-a').css("background-position","0 6px");
		$('#diente12-a').css("background-repeat","no-repeat");
		...
		$('#diente12b-a').css("background","url('img_pruebas/tabla3/periodontograma-dientes-arriba-12b.png')");
		$('#diente12b-a').css("background-position","0 18px");
		$('#diente12b-a').css("background-repeat","no-repeat");
	...
	$('#d11').toggle(
      function () {
        $('#diente11-a').css("background","url('img_pruebas/tabla1/tachados/periodontograma-dientes-arriba-tachados-11.png')");
		...
		$('#diente11b-a').css("background","url('img_pruebas/tabla3/tachados/periodontograma-dientes-arriba-tachados-11b.png')");
      ...
      function () {
		$('#diente11-a').css("background","url('img_pruebas/tabla1/periodontograma-dientes-arriba-11.png')");
		$('#diente11-a').css("background-position","bottom");
		$('#diente11-a').css("background-repeat","no-repeat");
		...
		$('#diente11b-a').css("background","url('img_pruebas/tabla3/periodontograma-dientes-arriba-11b.png')");
		$('#diente11b-a').css("background-position","0 12px");
		$('#diente11b-a').css("background-repeat","no-repeat");
	...
	$('#d48b').toggle(
      function () {
        $('#diente48b-a').css("background","url('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-48b.png')");
		...
		$('#diente48-a').css("background","url('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-48.png')");
      ...
      function () {
	  	$('#diente48b-a').css("background","url('img_pruebas/tabla7/periodontograma-dientes-abajo-48b.png')");
		$('#diente48b-a').css("background-position","0 24px");
		$('#diente48b-a').css("background-repeat","no-repeat");
		...
		$('#diente48-a').css("background","url('img_pruebas/tabla5/periodontograma-dientes-abajo-48.png')");
		$('#diente48-a').css("background-position","0 -4px");
		$('#diente48-a').css("background-repeat","no-repeat");
	...
	$('#d47b').toggle(
      function () {
        $('#diente47b-a').css("background","url('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-47b.png')");
		...
		$('#diente47-a').css("background","url('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-47.png')");
      ...
      function () {
		$('#diente47b-a').css("background","url('img_pruebas/tabla7/periodontograma-dientes-abajo-47b.png')");
		$('#diente47b-a').css("background-position","0 22px");
		$('#diente47b-a').css("background-repeat","no-repeat");
		...
		$('#diente47-a').css("background","url('img_pruebas/tabla5/periodontograma-dientes-abajo-47.png')");
		$('#diente47-a').css("background-position","0 -4px");
		$('#diente47-a').css("background-repeat","no-repeat");
	...
	$('#d46b').toggle(
      function () {
        $('#diente46b-a').css("background","url('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-46b.png')");
		...
		$('#diente46-a').css("background","url('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-46.png')");
      ...
      function () {
		$('#diente46b-a').css("background","url('img_pruebas/tabla7/periodontograma-dientes-abajo-46b.png')");
		$('#diente46b-a').css("background-position","0 23px");
		$('#diente46b-a').css("background-repeat","no-repeat");
		...
		$('#diente46-a').css("background","url('img_pruebas/tabla5/periodontograma-dientes-abajo-46.png')");
		$('#diente46-a').css("background-position","0 4px");
		$('#diente46-a').css("background-repeat","no-repeat");
	...
	$('#d45b').toggle(
      function () {
        $('#diente45b-a').css("background","url('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-45b.png')");
		...
		$('#diente45-a').css("background","url('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-45.png')");
      ...
      function () {
		$('#diente45b-a').css("background","url('img_pruebas/tabla7/periodontograma-dientes-abajo-45b.png')");
		...
		$('#diente45-a').css("background","url('img_pruebas/tabla5/periodontograma-dientes-abajo-45.png')");
		$('#diente45-a').css("background-position","0 1px");
		$('#diente45-a').css("background-repeat","no-repeat");
	...
	$('#d44b').toggle(
      function () {
        $('#diente44b-a').css("background","url('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-44b.png')");
		...
		$('#diente44-a').css("background","url('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-44.png')");
      ...
      function () {
		$('#diente44b-a').css("background","url('img_pruebas/tabla7/periodontograma-dientes-abajo-44b.png')");
		$('#diente44b-a').css("background-position","0 13px");
		$('#diente44b-a').css("background-repeat","no-repeat");
		...
		$('#diente44-a').css("background","url('img_pruebas/tabla5/periodontograma-dientes-abajo-44.png')");
		$('#diente44-a').css("background-position","0 3px");
		$('#diente44-a').css("background-repeat","no-repeat");
	...
	$('#d43b').toggle(
      function () {
        $('#diente43b-a').css("background","url('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-43b.png')");
		...
		$('#diente43-a').css("background","url('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-43.png')");
      ...
      function () {
		$('#diente43b-a').css("background","url('img_pruebas/tabla7/periodontograma-dientes-abajo-43b.png')");
		$('#diente43b-a').css("background-position","0 12px");
		$('#diente43b-a').css("background-repeat","no-repeat");
		...
		$('#diente43-a').css("background","url('img_pruebas/tabla5/periodontograma-dientes-abajo-43.png')");
		$('#diente43-a').css("background-position","0 7px");
		$('#diente43-a').css("background-repeat","no-repeat");
	...
	$('#d42b').toggle(
      function () {
        $('#diente42b-a').css("background","url('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-42b.png')");
		...
		$('#diente42-a').css("background","url('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-42.png')");
      ...
      function () {
		$('#diente42b-a').css("background","url('img_pruebas/tabla7/periodontograma-dientes-abajo-42b.png')");
		$('#diente42b-a').css("background-position","0 15px");
		$('#diente42b-a').css("background-repeat","no-repeat");
		...
		$('#diente42-a').css("background","url('img_pruebas/tabla5/periodontograma-dientes-abajo-42.png')");
		$('#diente42-a').css("background-position","0 3px");
		$('#diente42-a').css("background-repeat","no-repeat");
	...
	$('#d41b').toggle(
      function () {
        $('#diente41b-a').css("background","url('img_pruebas/tabla7/tachados/periodontograma-dientes-abajo-tachados-41b.png')");
		...
		$('#diente41-a').css("background","url('img_pruebas/tabla5/tachados/periodontograma-dientes-abajo-tachados-41.png')");
      ...
      function () {
		$('#diente41b-a').css("background","url('img_pruebas/tabla7/periodontograma-dientes-abajo-41b.png')");
		$('#diente41b-a').css("background-position","0 19px");
		$('#diente41b-a').css("background-repeat","no-repeat");
		...
		$('#diente41-a').css("background","url('img_pruebas/tabla5/periodontograma-dientes-abajo-41.png')");
		$('#diente41-a').css("background-position","0 1px");
		$('#diente41-a').css("background-repeat","no-repeat");
...
//IMPLANTES
	$('#i18').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#f18').css({"background":"#FFFFFF"});
		$('#diente18-a').css("background","url('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-18.png')");
		$('#diente18-a').css("background-position","0 -2px");
		$('#diente18-a').css("background-repeat","no-repeat");

		$('#diente18b-a').css("background","url('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-18b.png')");
		$('#diente18b-a').css("background-position","0 23px");
		$('#diente18b-a').css("background-repeat","no-repeat");
      ...
      function () {
        $(this).css({"background":"url('img_pruebas/periodontograma-oblicuas.png') repeat-x center"});
		$('#diente18-a').css("background","url('img_pruebas/tabla1/periodontograma-dientes-arriba-18.png')");
		$('#diente18-a').css("background-position","0 -2px");
		$('#diente18-a').css("background-repeat","no-repeat");
	...
	$('#i17').toggle(
      function () {
		...
		$('#diente17-a').css("background","url('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-17.png')");
		$('#diente17-a').css("background-position","0 -1px");
		$('#diente17-a').css("background-repeat","no-repeat");

		$('#diente17b-a').css("background","url('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-17b.png')");
		$('#diente17b-a').css("background-position","0 24px");
		$('#diente17b-a').css("background-repeat","no-repeat");
      ...
      function () {
		...
		$('#diente16-a').css("background","url('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-16.png')");
		$('#diente16-a').css("background-position","0 4px");
		$('#diente16-a').css("background-repeat","no-repeat");

		$('#diente16b-a').css("background","url('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-16b.png')");
		$('#diente16b-a').css("background-position","0 22px");
		$('#diente16b-a').css("background-repeat","no-repeat");
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente15-a').css("background","url('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-15.png')");
		$('#diente15-a').css("background-position","0 4px");
		$('#diente15-a').css("background-repeat","no-repeat");

		$('#diente15b-a').css("background","url('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-15b.png')");
		$('#diente15b-a').css("background-position","0 17px");
		$('#diente15b-a').css("background-repeat","no-repeat");
      },
      function () {
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente14-a').css("background","url('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-14.png')");
		$('#diente14-a').css("background-repeat","no-repeat");

		$('#diente14b-a').css("background","url('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-14b.png')");
		$('#diente14b-a').css("background-position","0 17px");
		$('#diente14b-a').css("background-repeat","no-repeat");
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente13-a').css("background","url('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-13.png')");
		$('#diente13-a').css("background-position","0 2px");
		$('#diente13-a').css("background-repeat","no-repeat");

		$('#diente13b-a').css("background","url('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-13b.png')");
		$('#diente13b-a').css("background-position","0 16px");
		$('#diente13b-a').css("background-repeat","no-repeat");
      },
      function () {
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente12-a').css("background","url('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-12.png')");
		$('#diente12-a').css("background-position","0 4px");
		$('#diente12-a').css("background-repeat","no-repeat");

		$('#diente12b-a').css("background","url('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-12b.png')");
		$('#diente12b-a').css("background-position","0 18px");
		$('#diente12b-a').css("background-repeat","no-repeat");
      },
      function () {
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente11-a').css("background","url('img_pruebas/tabla1/implantes/periodontograma-dientes-arriba-tornillo-11.png')");
		$('#diente11-a').css("background-position","bottom");
		$('#diente11-a').css("background-repeat","no-repeat");

		$('#diente11b-a').css("background","url('img_pruebas/tabla3/implantes/periodontograma-dientes-arriba-tornillo-11b.png')");
		$('#diente11b-a').css("background-position","0 12px");
		$('#diente11b-a').css("background-repeat","no-repeat");
      },
      function () {
	...
	$('#f18').toggle(
		function () {
			$(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
			$('#i18').css({"background":"#FFFFFF"});
			$('#furca18').css("background","url('img_pruebas/vacio.png')");
		},
		function () {
			$(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
			$('#furca18').css("background","url('img_pruebas/mediolleno.png')");
		},
		function () {
			$(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
			$('#furca18').css("background","url('img_pruebas/lleno.png')");
		},
		function () {
			$(this).css({"background":"#FFFFFF"});
			$('#furca18').css("background","none");
...
$('#f17').toggle(
      function () {
		...
		$('#furca17').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca17').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca17').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca17').css("background","none");
...
$('#f16').toggle(
      function () {
		...
		$('#furca16').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca16').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca16').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca16').css("background","none");
...
//TACHADOS
	...
	$('#d21').toggle(
      function () {
        $('#diente21-a').css("background","url('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-21.png')");
		...
		$('#diente21b-a').css("background","url('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-21b.png')");
      ...
      function () {
		$('#diente21-a').css("background","url('img_pruebas/tabla2/periodontograma-dientes-arriba-21.png')");
		$('#diente21-a').css("background-position","bottom");
		$('#diente21-a').css("background-repeat","no-repeat");
		...
		$('#diente21b-a').css("background","url('img_pruebas/tabla4/periodontograma-dientes-arriba-21b.png')");
		$('#diente21b-a').css("background-position","0 11px");
		$('#diente21b-a').css("background-repeat","no-repeat");
	...
	$('#d22').toggle(
      function () {
        $('#diente22-a').css("background","url('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-22.png')");
		...
		$('#diente22b-a').css("background","url('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-22b.png')");
      ...
      function () {
		$('#diente22-a').css("background","url('img_pruebas/tabla2/periodontograma-dientes-arriba-22.png')");
		$('#diente22-a').css("background-position","0px 6px");
		$('#diente22-a').css("background-repeat","no-repeat");
		...
		$('#diente22b-a').css("background","url('img_pruebas/tabla4/periodontograma-dientes-arriba-22b.png')");
		$('#diente22b-a').css("background-position","0px 17px");
		$('#diente22b-a').css("background-repeat","no-repeat");
	...
	$('#d23').toggle(
      function () {
        $('#diente23-a').css("background","url('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-23.png')");
		...
		$('#diente23b-a').css("background","url('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-23b.png')");
      ...
      function () {
		$('#diente23-a').css("background","url('img_pruebas/tabla2/periodontograma-dientes-arriba-23.png')");
		$('#diente23-a').css("background-position","top");
		$('#diente23-a').css("background-repeat","no-repeat");
		...
		$('#diente23b-a').css("background","url('img_pruebas/tabla4/periodontograma-dientes-arriba-23b.png')");
		$('#diente23b-a').css("background-position","0 15px");
		$('#diente23b-a').css("background-repeat","no-repeat");
	...
	$('#d24').toggle(
      function () {
        $('#diente24-a').css("background","url('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-24.png')");
		...
		$('#diente24b-a').css("background","url('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-24b.png')");
      ...
      function () {
		$('#diente24-a').css("background","url('img_pruebas/tabla2/periodontograma-dientes-arriba-24.png')");
		$('#diente24-a').css("background-position","0");
		$('#diente24-a').css("background-repeat","no-repeat");
		...
		$('#diente24b-a').css("background","url('img_pruebas/tabla4/periodontograma-dientes-arriba-24b.png')");
		$('#diente24b-a').css("background-position","0 16px");
		$('#diente24b-a').css("background-repeat","no-repeat");
	...
	$('#d25').toggle(
      function () {
        $('#diente25-a').css("background","url('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-25.png')");
		...
		$('#diente25b-a').css("background","url('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-25b.png')");
      ...
      function () {
		$('#diente25-a').css("background","url('img_pruebas/tabla2/periodontograma-dientes-arriba-25.png')");
		$('#diente25-a').css("background-position","0 5px");
		$('#diente25-a').css("background-repeat","no-repeat");
		...
		$('#diente25b-a').css("background","url('img_pruebas/tabla4/periodontograma-dientes-arriba-25b.png')");
		$('#diente25b-a').css("background-position","0 16px");
		$('#diente25b-a').css("background-repeat","no-repeat");
	...
	$('#d26').toggle(
      function () {
        $('#diente26-a').css("background","url('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-26.png')");
		...
		$('#diente26b-a').css("background","url('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-26b.png')");
      ...
      function () {
		$('#diente26-a').css("background","url('img_pruebas/tabla2/periodontograma-dientes-arriba-26.png')");
		$('#diente26-a').css("background-position","0 4px");
		$('#diente26-a').css("background-repeat","no-repeat");
		...
		$('#diente26b-a').css("background","url('img_pruebas/tabla4/periodontograma-dientes-arriba-26b.png')");
		$('#diente26b-a').css("background-position","0 21px");
		$('#diente26b-a').css("background-repeat","no-repeat");
	...
	$('#d27').toggle(
      function () {
        $('#diente27-a').css("background","url('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-27.png')");
		...
		$('#diente27b-a').css("background","url('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-27b.png')");
      ...
      function () {
		$('#diente27-a').css("background","url('img_pruebas/tabla2/periodontograma-dientes-arriba-27.png')");
		$('#diente27-a').css("background-position","0px 0px");
		$('#diente27-a').css("background-repeat","no-repeat");
		...
		$('#diente27b-a').css("background","url('img_pruebas/tabla4/periodontograma-dientes-arriba-27b.png')");
		$('#diente27b-a').css("background-position","0px 24px");
		$('#diente27b-a').css("background-repeat","no-repeat");
	...
	$('#d28').toggle(
      function () {
        $('#diente28-a').css("background","url('img_pruebas/tabla2/tachados/periodontograma-dientes-arriba-tachados-28.png')");
		...
		$('#diente28b-a').css("background","url('img_pruebas/tabla4/tachados/periodontograma-dientes-arriba-tachados-28b.png')");
      ...
      function () {
		$('#diente28-a').css("background","url('img_pruebas/tabla2/periodontograma-dientes-arriba-28.png')");
		$('#diente28-a').css("background-position","0 -2px");
		$('#diente28-a').css("background-repeat","no-repeat");
		...
		$('#diente28b-a').css("background","url('img_pruebas/tabla4/periodontograma-dientes-arriba-28b.png')");
		$('#diente28b-a').css("background-position","0 23px");
		$('#diente28b-a').css("background-repeat","no-repeat");
...
//IMPLANTES
	...
	$('#i21').toggle(
      function () {
		...
		$('#diente21-a').css("background","url('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-21.png')");
		$('#diente21-a').css("background-position","bottom");
		$('#diente21-a').css("background-repeat","no-repeat");

		$('#diente21b-a').css("background","url('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-21b.png')");
		$('#diente21b-a').css("background-position","0 11px");
		$('#diente21b-a').css("background-repeat","no-repeat");
      },
      function () {
	...
	$('#i22').toggle(
      function () {
		...
		$('#diente22-a').css("background","url('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-22.png')");
		$('#diente22-a').css("background-position","0px 6px");
		$('#diente22-a').css("background-repeat","no-repeat");

		$('#diente22b-a').css("background","url('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-22b.png')");
		$('#diente22b-a').css("background-position","0px 17px");
		$('#diente22b-a').css("background-repeat","no-repeat");
      },
      function () {
      ...
      function () {
		...
		$('#diente23-a').css("background","url('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-23.png')");
		$('#diente23-a').css("background-position","top");
		$('#diente23-a').css("background-repeat","no-repeat");

		$('#diente23b-a').css("background","url('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-23b.png')");
		$('#diente23b-a').css("background-position","0 15px");
		$('#diente23b-a').css("background-repeat","no-repeat");
      },
      function () {
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente24-a').css("background","url('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-24.png')");
		$('#diente24-a').css("background-repeat","no-repeat");

		$('#diente24b-a').css("background","url('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-24b.png')");
		$('#diente24b-a').css("background-repeat","no-repeat");
		$('#diente24b-a').css("background-position","0 16px");
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente25-a').css("background","url('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-25.png')");
		$('#diente25-a').css("background-position","0 5px");
		$('#diente25-a').css("background-repeat","no-repeat");

		$('#diente25b-a').css("background","url('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-25b.png')");
		$('#diente25b-a').css("background-position","0 16px");
		$('#diente25b-a').css("background-repeat","no-repeat");
      },
      function () {
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente26-a').css("background","url('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-26.png')");
		$('#diente26-a').css("background-position","0 4px");
		$('#diente26-a').css("background-repeat","no-repeat");

		$('#diente26b-a').css("background","url('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-26b.png')");
		$('#diente26b-a').css("background-position","0 21px");
		$('#diente26b-a').css("background-repeat","no-repeat");
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente27-a').css("background","url('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-27.png')");
		$('#diente27-a').css("background-repeat","no-repeat");

		$('#diente27b-a').css("background","url('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-27b.png')");
		$('#diente27b-a').css("background-repeat","no-repeat");
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente28-a').css("background","url('img_pruebas/tabla2/implantes/periodontograma-dientes-arriba-tornillo-28.png')");
		$('#diente28-a').css("background-position","0 -2px");
		$('#diente28-a').css("background-repeat","no-repeat");

		$('#diente28b-a').css("background","url('img_pruebas/tabla4/implantes/periodontograma-dientes-arriba-tornillo-28b.png')");
		$('#diente28b-a').css("background-position","0 23px");
		$('#diente28b-a').css("background-repeat","no-repeat");
...
$('#f26').toggle(
      function () {
		...
		$('#furca26').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca26').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca26').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca26').css("background","none");
...
$('#f27').toggle(
      function () {
		...
		$('#furca27').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca27').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca27').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca27').css("background","none");
...
$('#f28').toggle(
      function () {
		...
		$('#furca28').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca28').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca28').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca28').css("background","none");
...
$('#f18b-a').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca18-a').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca18-a').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca18-a').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca18-a').css("background","none");
...
$('#f18b-b').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca18-b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca18-b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca18-b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca18-b').css("background","none");
...
$('#f17b-a').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca17-a').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca17-a').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca17-a').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca17-a').css("background","none");
...
$('#f17b-b').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca17-b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca17-b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca17-b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca17-b').css("background","none");
...
$('#f16b-a').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca16-a').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca16-a').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca16-a').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca16-a').css("background","none");
...
$('#f16b-b').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca16-b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca16-b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca16-b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca16-b').css("background","none");
...
$('#f14b-a').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca14-a').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca14-a').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca14-a').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca14-a').css("background","none");
...
$('#f14b-b').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca14-b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca14-b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca14-b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca14-b').css("background","none");
...
$('#f24b-a').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca24-a').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca24-a').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca24-a').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca24-a').css("background","none");
...
$('#f24b-b').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca24-b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca24-b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca24-b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca24-b').css("background","none");
...
$('#f26b-a').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca26-a').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca26-a').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca26-a').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca26-a').css("background","none");
...
$('#f26b-b').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca26-b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca26-b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca26-b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca26-b').css("background","none");
...
$('#f27b-a').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca27-a').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca27-a').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca27-a').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca27-a').css("background","none");
...
$('#f27b-b').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca27-b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca27-b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca27-b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca27-b').css("background","none");
...
$('#f28b-a').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca28-a').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca28-a').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca28-a').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca28-a').css("background","none");
...
$('#f28b-b').toggle(
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/vacio.png') no-repeat center"});
		$('#furca28-b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca28-b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca28-b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca28-b').css("background","none");
...
$('#f48').toggle(
      function () {
		...
		$('#furca48').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca48').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca48').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
...
$('#f47').toggle(
      function () {
		...
		$('#furca47').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca47').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca47').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
...
$('#f46').toggle(
      function () {
		...
		$('#furca46').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca46').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca46').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
...
$('#f38').toggle(
      function () {
		...
		$('#furca38').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca38').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca38').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
...
$('#f37').toggle(
      function () {
		...
		$('#furca37').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca37').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca37').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
...
$('#f36').toggle(
      function () {
		...
		$('#furca36').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca36').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca36').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
...
$('#f48b').toggle(
      function () {
		...
		$('#furca48b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca48b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca48b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca48b').css("background","none");
...
$('#f47b').toggle(
      function () {
		...
		$('#furca47b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca47b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca47b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca47b').css("background","none");
...
$('#f46b').toggle(
      function () {
		...
		$('#furca46b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca46b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca46b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
		$('#furca46b').css("background","none");
...
$('#f38b').toggle(
      function () {
		...
		$('#furca38b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca38b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca38b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
...
$('#f37b').toggle(
      function () {
		...
		$('#furca37b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca37b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca37b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
...
$('#f36b').toggle(
      function () {
		...
		$('#furca36b').css("background","url('img_pruebas/vacio.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/mediolleno.png') no-repeat center"});
		$('#furca36b').css("background","url('img_pruebas/mediolleno.png')");
      },
	  function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/lleno.png') no-repeat center"});
		$('#furca36b').css("background","url('img_pruebas/lleno.png')");
      },
      function () {
        $(this).css({"background":"#FFFFFF"});
      ...
      function () {
		...
		$('#diente48-a').css("background","url('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-48.png')");
		$('#diente48-a').css("background-position","0 -4px");
		$('#diente48-a').css("background-repeat","no-repeat");

		$('#diente48b-a').css("background","url('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-48b.png')");
		$('#diente48b-a').css("background-position","0 24px");
		$('#diente48b-a').css("background-repeat","no-repeat");
	...
	$('#i47b').toggle(
      function () {
		...
		$('#diente47-a').css("background","url('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-47.png')");
		$('#diente47-a').css("background-position","0 4px");
		$('#diente47-a').css("background-repeat","no-repeat");

		$('#diente47b-a').css("background","url('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-47b.png')");
		$('#diente47b-a').css("background-position","0 22px");
		$('#diente47b-a').css("background-repeat","no-repeat");
      ...
      function () {
		...
		$('#diente46-a').css("background","url('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-46.png')");
		$('#diente46-a').css("background-position","0 -1px");
		$('#diente46-a').css("background-repeat","no-repeat");

		$('#diente46b-a').css("background","url('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-46b.png')");
		$('#diente46b-a').css("background-position","0 23px");
		$('#diente46b-a').css("background-repeat","no-repeat");
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente45-a').css("background","url('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-45.png')");
		$('#diente45-a').css("background-position","0 1px");
		$('#diente45-a').css("background-repeat","no-repeat");

		$('#diente45b-a').css("background","url('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-45b.png')");
		$('#diente45b-a').css("background-position","0 20px");
		$('#diente45b-a').css("background-repeat","no-repeat");
      },
      function () {
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente44-a').css("background","url('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-44.png')");
		$('#diente44-a').css("background-position","0 3px");
		$('#diente44-a').css("background-repeat","no-repeat");

		$('#diente44b-a').css("background","url('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-44b.png')");
		$('#diente44b-a').css("background-position","0 13px");
		$('#diente44b-a').css("background-repeat","no-repeat");
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente43-a').css("background","url('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-43.png')");
		$('#diente43-a').css("background-position","0 7px");
		$('#diente43-a').css("background-repeat","no-repeat");

		$('#diente43b-a').css("background","url('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-43b.png')");
		$('#diente43b-a').css("background-position","0 12px");
		$('#diente43b-a').css("background-repeat","no-repeat");
      },
      function () {
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente42-a').css("background","url('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-42.png')");
		$('#diente42-a').css("background-position","0 3px");
		$('#diente42-a').css("background-repeat","no-repeat");

		$('#diente42b-a').css("background","url('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-42b.png')");
		$('#diente42b-a').css("background-position","0 15px");
		$('#diente42b-a').css("background-repeat","no-repeat");
      },
      function () {
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente41-a').css("background","url('img_pruebas/tabla5/implantes/periodontograma-dientes-abajo-tornillo-41.png')");
		$('#diente41-a').css("background-position","0 1px");
		$('#diente41-a').css("background-repeat","no-repeat");

		$('#diente41b-a').css("background","url('img_pruebas/tabla7/implantes/periodontograma-dientes-abajo-tornillo-41b.png')");
		$('#diente41b-a').css("background-position","0 19px");
		$('#diente41b-a').css("background-repeat","no-repeat");
      },
      function () {
...
$('#i31b').toggle(
      function () {
		...
		$('#diente31-a').css("background","url('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-31.png')");
		$('#diente31-a').css("background-position","0 1px");
		$('#diente31-a').css("background-repeat","no-repeat");

		$('#diente31b-a').css("background","url('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-31b.png')");
		$('#diente31b-a').css("background-position","0 19px");
		$('#diente31b-a').css("background-repeat","no-repeat");
      },
      function () {
        $(this).css({"background":"url('img_pruebas/periodontograma-oblicuas.png') repeat-x center"});
		$('#diente31-a').css("background","url('img_pruebas/tabla6/periodontograma-dientes-abajo-31.png')");
		$('#diente31-a').css("background-position","0 1px");
		$('#diente31-a').css("background-repeat","no-repeat");

		$('#diente31b-a').css("background","url('img_pruebas/tabla8/periodontograma-dientes-abajo-31b.png')");
		$('#diente31b-a').css("background-position","0 19px");
		$('#diente31b-a').css("background-repeat","no-repeat");
      }
	);
	...
	$('#i32b').toggle(
      function () {
		...
		$('#diente32-a').css("background","url('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-32.png')");
		$('#diente32-a').css("background-position","0 3px");
		$('#diente32-a').css("background-repeat","no-repeat");

		$('#diente32b-a').css("background","url('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-32b.png')");
		$('#diente32b-a').css("background-position","0px 15px");
		$('#diente32b-a').css("background-repeat","no-repeat");
      },
      function () {
        $(this).css({"background":"url('img_pruebas/periodontograma-oblicuas.png') repeat-x center"});
		$('#diente32-a').css("background","url('img_pruebas/tabla6/periodontograma-dientes-abajo-32.png')");
		$('#diente32-a').css("background-position","0px 3px");
		$('#diente32-a').css("background-repeat","no-repeat");

		$('#diente32b-a').css("background","url('img_pruebas/tabla8/periodontograma-dientes-abajo-32b.png')");
		$('#diente32b-a').css("background-position","0px 15px");
		$('#diente32b-a').css("background-repeat","no-repeat");
      }
	);
      ...
      function () {
		...
		$('#diente33-a').css("background","url('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-33.png')");
		$('#diente33-a').css("background-position","0 7px");
		$('#diente33-a').css("background-repeat","no-repeat");

		$('#diente33b-a').css("background","url('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-33b.png')");
		$('#diente33b-a').css("background-position","0 12px");
		$('#diente33b-a').css("background-repeat","no-repeat");
      },
      function () {
        $(this).css({"background":"url('img_pruebas/periodontograma-oblicuas.png') repeat-x center"});
		$('#diente33-a').css("background","url('img_pruebas/tabla6/periodontograma-dientes-abajo-33.png')");
		$('#diente33-a').css("background-position","0 7px");
		$('#diente33-a').css("background-repeat","no-repeat");

		$('#diente33b-a').css("background","url('img_pruebas/tabla8/periodontograma-dientes-abajo-33b.png')");
		$('#diente33b-a').css("background-position","0 12px");
		$('#diente33b-a').css("background-repeat","no-repeat");
      }
	);
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente34-a').css("background","url('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-34.png')");
		$('#diente34-a').css("background-position","0 5px");
		$('#diente34-a').css("background-repeat","no-repeat");

		$('#diente34b-a').css("background","url('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-34b.png')");
		$('#diente34b-a').css("background-repeat","no-repeat");
		$('#diente34b-a').css("background-position","0 13px");
      },
      function () {
        $(this).css({"background":"url('img_pruebas/periodontograma-oblicuas.png') repeat-x center"});
		$('#diente34-a').css("background","url('img_pruebas/tabla6/periodontograma-dientes-abajo-34.png')");
		$('#diente34-a').css("background-position","0 5px");
		$('#diente34-a').css("background-repeat","no-repeat");

		$('#diente34b-a').css("background","url('img_pruebas/tabla8/periodontograma-dientes-abajo-34b.png')");
		$('#diente34b-a').css("background-repeat","no-repeat");
		$('#diente34b-a').css("background-position","0 13px");
      }
	);
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente35-a').css("background","url('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-35.png')");
		$('#diente35-a').css("background-position","0 1px");
		$('#diente35-a').css("background-repeat","no-repeat");

		$('#diente35b-a').css("background","url('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-35b.png')");
		$('#diente35b-a').css("background-position","0 20px");
		$('#diente35b-a').css("background-repeat","no-repeat");
      },
      function () {
        $(this).css({"background":"url('img_pruebas/periodontograma-oblicuas.png') repeat-x center"});
		$('#diente35-a').css("background","url('img_pruebas/tabla6/periodontograma-dientes-abajo-35.png')");
		$('#diente35-a').css("background-position","0 1px");
		$('#diente35-a').css("background-repeat","no-repeat");

		$('#diente35b-a').css("background","url('img_pruebas/tabla8/periodontograma-dientes-abajo-35b.png')");
		$('#diente35b-a').css("background-position","0 20px");
		$('#diente35b-a').css("background-repeat","no-repeat");
      }
	);
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente36-a').css("background","url('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-36.png')");
		$('#diente36-a').css("background-position","top");
		$('#diente36-a').css("background-repeat","no-repeat");

		$('#diente36b-a').css("background","url('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-36b.png')");
      ...
      function () {
        $(this).css({"background":"url('img_pruebas/periodontograma-oblicuas.png') repeat-x center"});
		$('#diente36-a').css("background","url('img_pruebas/tabla6/periodontograma-dientes-abajo-36.png')");
		$('#diente36-a').css("background-position","top");
		$('#diente36-a').css("background-repeat","no-repeat");

		$('#diente36b-a').css("background","url('img_pruebas/tabla8/periodontograma-dientes-abajo-36b.png')");
		$('#diente36b-a').css("background-position","0 23px");
		$('#diente36b-a').css("background-repeat","no-repeat");
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente37-a').css("background","url('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-37.png')");
		$('#diente37-a').css("background-repeat","no-repeat");
		$('#diente37-a').css("background-position"," 0px -4px");

		$('#diente37b-a').css("background","url('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-37b.png')");
      ...
      function () {
        $(this).css({"background":"url('img_pruebas/periodontograma-oblicuas.png') repeat-x center"});
		$('#diente37-a').css("background","url('img_pruebas/tabla6/periodontograma-dientes-abajo-37.png')");
		$('#diente37-a').css("background-repeat","no-repeat");
		$('#diente37-a').css("background-position"," 0px -4px");

		$('#diente37b-a').css("background","url('img_pruebas/tabla8/periodontograma-dientes-abajo-37b.png')");
		$('#diente37b-a').css("background-repeat","no-repeat");
		$('#diente37b-a').css("background-position","0 21px");
      ...
      function () {
        $(this).css({"background":"#FFFFFF url('img_pruebas/cuadrado.png') no-repeat center"});
		$('#diente38-a').css("background","url('img_pruebas/tabla6/implantes/periodontograma-dientes-abajo-tornillo-38.png')");
		$('#diente38-a').css("background-position","0 -3px");
		$('#diente38-a').css("background-repeat","no-repeat");

		$('#diente38b-a').css("background","url('img_pruebas/tabla8/implantes/periodontograma-dientes-abajo-tornillo-38b.png')");
      ...
      function () {
        $(this).css({"background":"url('img_pruebas/periodontograma-oblicuas.png') repeat-x center"});
		$('#diente38-a').css("background","url('img_pruebas/tabla6/periodontograma-dientes-abajo-38.png')");
		$('#diente38-a').css("background-position","0 -3px");
		$('#diente38-a').css("background-repeat","no-repeat");

		$('#diente38b-a').css("background","url('img_pruebas/tabla8/periodontograma-dientes-abajo-38b.png')");
		$('#diente38b-a').css("background-position","0 24px");
		$('#diente38b-a').css("background-repeat","no-repeat");
	...
	$('#d31b').toggle(
      function () {
        $('#diente31b-a').css("background","url('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-31b.png')");
		$('#diente31b-a').css("background-position","0 19px");
		$('#diente31b-a').css("background-repeat","no-repeat");
		...
		$('#diente31-a').css("background","url('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-31.png')");
		$('#diente31-a').css("background-position","0 1px");
		$('#diente31-a').css("background-repeat","no-repeat");
	...
	$('#d32b').toggle(
      function () {
        $('#diente32b-a').css("background","url('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-32b.png')");
		$('#diente32b-a').css("background-position","0px 15px");
		$('#diente32b-a').css("background-repeat","no-repeat");
		...
		$('#diente32-a').css("background","url('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-32.png')");
		$('#diente32-a').css("background-position","0px 3px");
		$('#diente32-a').css("background-repeat","no-repeat");
	...
	$('#d33b').toggle(
      function () {
        $('#diente33b-a').css("background","url('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-33b.png')");
		$('#diente33b-a').css("background-position","0 12px");
		$('#diente33b-a').css("background-repeat","no-repeat");
		...
		$('#diente33-a').css("background","url('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-33.png')");
		$('#diente33-a').css("background-position","0 7px");
		$('#diente33-a').css("background-repeat","no-repeat");
	...
	$('#d34b').toggle(
      function () {
        $('#diente34b-a').css("background","url('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-34b.png')");
		$('#diente34b-a').css("background-position","0 13px");
		$('#diente34b-a').css("background-repeat","no-repeat");
		...
		$('#diente34-a').css("background","url('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-34.png')");
		$('#diente34-a').css("background-position","0 5px");
		$('#diente34-a').css("background-repeat","no-repeat");
	...
	$('#d35b').toggle(
      function () {
        $('#diente35b-a').css("background","url('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-35b.png')");
		$('#diente35b-a').css("background-position","0 20px");
		$('#diente35b-a').css("background-repeat","no-repeat");
		...
		$('#diente35-a').css("background","url('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-35.png')");
		$('#diente35-a').css("background-position","0 1px");
		$('#diente35-a').css("background-repeat","no-repeat");
	...
	$('#d36b').toggle(
      function () {
        $('#diente36b-a').css("background","url('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-36b.png')");
		$('#diente36b-a').css("background-position","0 23px");
		$('#diente36b-a').css("background-repeat","no-repeat");
		...
		$('#diente36-a').css("background","url('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-36.png')");
		$('#diente36-a').css("background-position","top");
		$('#diente36-a').css("background-repeat","no-repeat");
	...
	$('#d37b').toggle(
      function () {
        $('#diente37b-a').css("background","url('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-37b.png')");
		...
		$('#diente37-a').css("background","url('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-37.png')");
		$('#diente37-a').css("background-position","0px -4px");
		$('#diente37-a').css("background-repeat","no-repeat");
	...
	$('#d38b').toggle(
      function () {
        $('#diente38b-a').css("background","url('img_pruebas/tabla8/tachados/periodontograma-dientes-abajo-tachados-38b.png')");
		$('#diente38b-a').css("background-position","0 24px");
		$('#diente38b-a').css("background-repeat","no-repeat");
		...
		$('#diente38-a').css("background","url('img_pruebas/tabla6/tachados/periodontograma-dientes-abajo-tachados-38.png')");
		$('#diente38-a').css("background-position","0 -3px");
		$('#diente38-a').css("background-repeat","no-repeat");
...
{{--  <form id='fsave' name='fsave' method='POST' action='save.php' target="hidden-form">
	...
	<input type="hidden" id="cod_con" name="cod_con" value="<?php echo($_POST['periodontograma_cod_con']);?>">
...
<?php
	...
	$cod_con= $_POST['periodontograma_cod_con'];
	$sql= "Select periodontograma from control where cod_con = ".$cod_con;
	$sth = $dba->prepare($sql);
	$sth->execute();
	$rsd = $sth->fetch(PDO::FETCH_NUM, PDO::FETCH_ORI_NEXT);
	$datos = $rsd[0];
	$arrstyle = array("i18","i17","i16","i15","i14","i13","i12","i11","i21","i22","i23","i24","i25","i26","i27","i28",
							"i31b","i32b","i33b","i34b","i35b","i36b","i37b","i38b","i48b","i47b","i46b","i45b","i44b","i43b","i42b","i41b",
							"f18","f17","f16","f26","f27","f28",
							"f18b-a","f18b-b","f17b-a","f17b-b","f16b-a","f16b-b","f14b-a","f14b-b","f24b-a","f24b-b","f26b-a","f26b-b","f27b-a","f27b-b","f28b-a","f28b-b",
							"f48","f47","f46","f36","f37","f38",
	...
	$obj = json_decode($datos);
		foreach ($obj as &$cajas) {
			if (in_array($cajas[0], $arrstyle)) {
				if ($cajas[1]!="") {
					print("document.getElementById('".$cajas[0]."').style.background='".$cajas[1]."';");
				}
 			} else {
				if ($cajas[1]!="") {
					print("document.getElementById('".$cajas[0]."').value='".$cajas[1]."';");
				}
			}
		}
	}
