    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title">Controles de enfermedades crónicas</h5>
                <button type="button" class="close" onclick="$('#form_enfermedad_cronica').modal('hide')" data-dismiss="modal" aria-label="Close">
