<style>
    ...
    #odontologia-avisos > div {
        display: flex;
    }

    #odontologia-avisos .alert-atencion {
        width: 100%;
        margin-bottom: .35rem;
        transition: opacity .45s ease;
    }

    #odontologia-avisos .alert-atencion.aviso-saliendo {
        opacity: 0;
    }
</style>
    ...
    <div class="col-md-12 py-0 px-2 ">
        <div class="row mx-0">
            <div class="col-sm-12 col-md-12">
                <ul class="nav nav-tabs-secciones mb-3 mt-3" id="odontologia-tabs" role="tablist">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="form-row mb-1" id="odontologia-avisos">
                ...
                <form action="{{ route('dental.registrar_ficha_atencion_dental') }}" method="POST">
                    ...
                    <div class="tab-content" id="od_endo-contenido">
                        ...
                        <div class="tab-pane fade" id="eval_periimpl" role="tabpanel"
                            ...
                            @include('atencion_odontologica.generales.periodontograma_veterinario')
                        </div>
                        <!-- ODONTOGRAMA-->
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h6 class="modal-title f-18">Agendar nueva cita</h6>
...
setTimeout(function(){
    ...
    <script>
        ...
        function actualizarTablaOdontologiaGeneralEnVivo(odontograma) {
            const tabla = $.fn.DataTable.isDataTable('#table_piezas_presupuesto_odonto')
            ...
            (odontograma || []).forEach(function(pieza) {
                ...
                const avance = Number(pieza.grado_avance || 0);
                const grafico = `<div class="avance-torta" style="--avance: ${avance}%" title="Avance: ${avance}%"><span>${avance}%</span></div>`;
                const acciones = '<button type="button" class="btn btn-danger btn-icon" onclick="eliminar_odontograma(' +
        ...
        function cargar_a_presupuesto_impl_g_confirmar() {
            ...
            let gradoAvance = $('#grado_avance_od_gral').val();
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    if (resp.status == 1) {
                        ...
                        actualizarTablaOdontologiaGeneralEnVivo(odontograma);
                        $('#paciente_piezas_dentales_ex').val(null).trigger('change');
                        $('.pieza').removeClass('seleccionada');
                        $('#diagnostico_combo_g_od_gral').val('0').trigger('change');
                        $('#diag_presupuesto_pieza_g').val('');
                        $('#grado_avance_od_gral').val('0');
                        $('#max_sup, #max_inf, #piezas_presup').prop('checked', false);
                        ...
                        odontograma.forEach(function(pieza) {
                                ...
                                if (pieza.presupuesto == 1 && pieza.urgencia == 0) {
                                    ...
                                    let rowNode = table_od_gral.row.add([
                                        ...
                                        pieza.descripcion,
                                        formatoMoneda(formatoMoneda(pieza.valor)),
                                        `<div class="avance-torta" style="--avance: ${pieza.grado_avance ?? 0}%" title="Avance: ${pieza.grado_avance ?? 0}%"><span>${pieza.grado_avance ?? 0}%</span></div>`,
    ...
    <script>
        ...
        $('#mensaje_ficha').show();
        setTimeout(function() {
            $('#mensaje_ficha').addClass('aviso-saliendo');
            setTimeout(function() { $('#mensaje_ficha').hide(); }, 450);
        }, 5000);
        @if ($fichas->count() > 0)
        ...
        setTimeout(function() {
            $('#mensaje_historias').addClass('aviso-saliendo');
            setTimeout(function() { $('#mensaje_historias').hide(); }, 450);
        }, 5000);
