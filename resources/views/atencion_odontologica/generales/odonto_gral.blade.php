@php
    ...
    $esCaninoOdontoGeneral = $esMascotaOdontoGeneral
        && \Illuminate\Support\Str::contains($nombreEspecieOdontoGeneral, ['canin', 'perro']);

    if ($esMascotaOdontoGeneral && $esCaninoOdontoGeneral) {
        $piezasOdontogramaGeneral = [
        ...
        $piezasOdontogramaGeneral = [];
        foreach ([1, 2, 3, 4] as $cuadranteOdontoGeneral) {
            foreach (range(1, 8) as $numeroOdontoGeneral) {
                $piezasOdontogramaGeneral[] = $cuadranteOdontoGeneral . '.' . $numeroOdontoGeneral;
            }
        }
    }
@endphp
                                    ...
                                    <div class="form-row mt-3">
                                        <div class="col-sm-12 col-md-12 col-lg-2 col-xl-2">
                                            <div class="nav flex-column nav-pills mb-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                ...
                                                <a class="nav-link-aten text-reset" id="imagenes_dent_tab" data-toggle="tab" href="#imagenes_dent" role="tab" aria-controls="imagenes_dent" aria-selected="false" onclick="restaurarImagenesOdontologiaGeneral(); mostrar_nuevas_imagenes_dent()">Imágenes</a>
                                            </div>
                                        </div>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        @if($o->urgencia == 0 && $o->presupuesto == 1)
                                                                            <tr>
                                                                                ...
                                                                                @php $avanceOdonto = max(0, min(100, (int) ($o->grado_avance ?? 0))); @endphp
                                                                                <td>
                                                                                    <div class="avance-torta" style="--avance: {{ $avanceOdonto }}%" title="Avance: {{ $avanceOdonto }}%">
                                                                                        <span>{{ $avanceOdonto }}%</span>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6 col-xxl-6 mt-2">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="js-example-basic-multiple" name="paciente_piezas_dentales_ex" id="paciente_piezas_dentales_ex" multiple="multiple">
                                                                            @foreach ($piezasOdontogramaGeneral as $codigoPiezaGeneral)
                                                                                <option value="{{ $codigoPiezaGeneral }}">{{ $codigoPiezaGeneral }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control form-control-sm" id="grado_avance_od_gral">
...
<script>
    ...
    function seleccionar_maxilar_superior() {
        ...
        piezas.forEach(pieza => {
            ...
            const cuadrante = codigo.includes('.') ? codigo.split('.')[0] : codigo.charAt(0);
