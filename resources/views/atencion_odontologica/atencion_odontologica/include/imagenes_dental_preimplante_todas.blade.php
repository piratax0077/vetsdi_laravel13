                ...
                <div class="form-row" id="contenedor_piezas_ex_oral">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control caja-texto form-control-sm mb-9" id="observaciones_ex_impl{{$count}}" name="observaciones_ex_impl0" onfocus="this.rows=4" onblur="this.rows=1;">{{ $imagen->observaciones_ex }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
