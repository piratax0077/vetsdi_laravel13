    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title mt-1" id="modal_eval_hab_preart">Examen de la sensibilidad</h5>
            ...
            <div class="modal-body">
                <form>
                    <div class="form-row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-1">
                            <h6 class="mb-3">II.- Secundaria</h6>
                            <div class="form-group">
                                <label class="floating-label-activo-sm">Examen</label>
                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="obs_resp" id="obs_resp"></textarea>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="comentarios" id="comentarios"></textarea>
                            </div>
                        </div>
                    </div>
                </form>
