    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title mt-1" id="modal_habla">Evaluación Habla y Lenguaje</h5>
                ...
                <form>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-8 mt-2">
                            <div class="form-group fill">
                                <label id="" name="" class="floating-label-activo-sm">Dislalias</label>
                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="dislalias" id="dislalias"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-sm-3 mt-3">
                            ...
                            <div class="form-group fill">
                                <select class="form-control form-control-sm" name="fluidez" id="fluidez">
                                    <option value="NO">•	Normal</option>
                                    <option value="ES">•	Espasmofemia</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-3 mt-3">
                            ...
                            <div class="form-group fill">
                                <select class="form-control form-control-sm" name="tipo" id="tipo">
                                    ...
                                    <option value="T">•	Tónico</option>
                                    <option value="C">•	Clónico</option>
                        ...
                        <div class="col-sm-3 mt-3">
                            ...
                            <div class="form-group fill">
                                <select class="form-control form-control-sm" name="ritmo" id="ritmo">
                                    <option value="A">•	Adecuado</option>
                                    <option value="B">•	Bradilália</option>
                                    <option value="T">•	Taquilália</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-3 mt-3">
                            ...
                            <div class="form-group fill">
                                <select class="form-control form-control-sm" name="prosodia" id="prosodia">
                                    <option value="A">•	Adecuada</option>
                                    <option value="E">•	Exagerada</option>
                                    <option value="M">•	Monótona</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-sm-4 mt-2">
                            <div class="form-group fill">
                                <H6 class="form_fono"> Lenguaje expresivo-receptivo</h6>
                            </div>
                        </div>
                        <div class="col-sm-8 mt-2">
                            <div class="form-group fill">
                                <label id="" name="" class="floating-label-activo-sm">Lenguaje expresivo-receptivo</label>
                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="leng_exp" id="leng_exp"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-sm-4 mt-2">
                            <div class="form-group fill">
                                <H6 class="form_fono"> Comentarios</h6>
                            </div>
                        </div>
                        <div class="col-sm-8 mt-2">
                            <div class="form-group fill">
                                <label id="" name="" class="floating-label-activo-sm">Lenguaje expresivo-receptivo</label>
                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="comentario" id="comentario"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-sm-4 mt-2">
                            <div class="form-group fill">
                                <H6 class="form_fono"> Diagnóstico</h6>
                            </div>
                        </div>
                        <div class="col-sm-8 mt-2">
                            <div class="form-group fill">
                                <label id="" name="" class="floating-label-activo-sm">Diagnóstico Fonoaudiológico</label>
                                <textarea class="form-control form-control-sm" rows="1" onfocus="this.rows=2" onblur="this.rows=1;" name="dg_fono" id="dg_fono"></textarea>
                            </div>
                        </div>
                    </div>
                </form>
