                ...
                <div class="form-group col-md-3 d-flex">
                    @if ($o->presupuesto == 1)
                        <button type="button" class="btn btn-icon btn-danger"
                            onclick="sacar_de_presupuesto_lab({{ $o->id }},'menor')"><i
                                class="fas fa-minus"></i></button>
                    @else
                        <button type="button" class="btn btn-icon btn-primary"
                            onclick="cargar_a_presupuesto_lab({{ $o->id }}, 'menor');"><i
        ...
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="form-group col-md-3 d-flex">
                    @if ($o->presupuesto == 1)
                        <button type="button" class="btn btn-icon btn-danger"
                            onclick="sacar_de_presupuesto_lab({{ $o->id }},'mayor')"><i
                                class="fas fa-minus"></i></button>
                    @else
                        <button type="button" class="btn btn-icon btn-primary"
                            onclick="cargar_a_presupuesto_lab({{ $o->id }},'mayor');"><i
                                class="feather icon-shopping-cart"></i>
                        </button>
                    @endif
                    <button type="button" class="btn btn-info btn-icon"onclick="info_lab({{ $o->id_laboratorio }});"><i
