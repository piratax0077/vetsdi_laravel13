                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <select name="tipo_sonda2.6" id="tipo_sonda2.6" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('period_inst','div_period_inst','obs_period_inst',5);">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" name="obs_tipo_sonda2.6" id="obs_tipo_sonda2.6" value="{{ $pieza18->cuerpo['obs_tipo_sonda'] ?? '' }}" />
                        </div>
                    </div>
                    @endif
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="form-group" id="obs_pieza2.6">
                            <label class="floating-label-activo-sm">Obs. Pieza 2.6</label>
                                <textarea class="form-control caja-texto form-control-sm" data-titulo="Obs Pieza 2.6" data-seccion="Eval_periimplantar"  rows="1" onfocus="this.rows=3" onblur="this.rows=1;" name="obs_26" id="obs_26" placeholder="Describa observaciones">{{ $pieza26->cuerpo['observaciones'] ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
