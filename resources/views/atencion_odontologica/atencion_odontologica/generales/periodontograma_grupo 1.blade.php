                        ...
                        <div id="#" style="width: 100%">
                            <table id="superior">
                                <tr>
                                    ...
                                    <td style="padding:5px;width:50%;text-align:center;"><input type="button" style="width:250px;"value="Guardar Datos" onclick="guardardatos();"></td>
                                </tr>
                            </table>
                                            ...
                                            <form name ="grafico1" id="grafico1" action="#">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="noborde">
                                                        ...
                                                        <div id="visualization18a" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 59px;"></div>
                                                        <div id="diente18-a"><div id="furca18"></div></div>
                                                    </td>
                                                    <td class="noborde">
                                                        <div id="visualization17a" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 57px;"></div>
                                                        <div id="diente17-a"><div id="furca17"></div></div>
                                                    </td>
                                                    <td class="noborde">
                                                        <div id="visualization16a" style="width: 55px; height: 160px;position:absolute;margin:0 0 0 52px;"></div>
                                                        <div id="diente16-a"><div id="furca16"></div></div>
                                                    </td>
                                                    <td class="noborde">
                                                        <div id="visualization15a" style="width: 28px; height: 160px;position:absolute;margin:0 0 0 64px;"></div>
                                                        <div id="diente15-a"></div>
                                                    </td>
                                                    <td class="noborde">
                                                        <div id="visualization14a" style="width: 28px; height: 160px;position:absolute;margin:0 0 0 63px;"></div>
                                                        <div id="diente14-a"></div>
                                                    </td>
                                                    <td class="noborde">
                                                        <div id="visualization13a" style="width: 28px; height: 160px;position:absolute;margin:0 0 0 61px;"></div>
                                                        <div id="diente13-a"></div>
                                                    </td>
                                                    <td class="noborde">
                                                        <div id="visualization12a" style="width: 27px; height: 160px;position:absolute;margin:0 0 0 65px;"></div>
                                                        <div id="diente12-a"></div>
                                                    </td>
                                                    <td class="noborde">
                                                        <div id="visualization11a" style="width: 33px; height: 160px;position:absolute;margin:0 0 0 63px;"></div>
                                            ...
                                            <form name ="grafico3" id="grafico3" action="#">
                                                <tr>
                                                    ...
                                                    <td class="noborde">
                                                        ...
                                                        <div id="visualization18b" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 59px;"></div>

                                                        <div id="diente18b-a"><div id="furca18-a"></div><div id="furca18-b"></div></div>
                                                    </td>
                                                    <td class="noborde">
                                                        <div id="visualization17b" style="width: 40px; height: 160px;position:absolute;margin:0 0 0 57px;"></div>
                                        ...
                                        <div id="tabla-resultados">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td><div id="suma2">0</div>% Higiene</td>
