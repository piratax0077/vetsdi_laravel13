    ...
    <div class="card-a">
        <div class="card-header-a" id="exam_odurg_ped">
            <button
                ...
                Urgencia Odontológica Veterinaria
            </button>
        </div>
                                                            ...
                                                            <div class="card-informacion">
                                                                <div class="card-top">
                                                                    <h6
                                                                        ...
                                                                        Insumos</h6>
                                                                    <button type="button"
                                                                        id="btn_agregar_insumo_urgencia"
                                                                        class="btn btn-info btn-xxs float-md-right d-inline"
                                                                        data-toggle="modal"
                                                                        data-target="#modal_insumos_urgencias"><i
                                                                            class="fas fa-plus"></i>
                                                                        Agregar
                                                            ...
                                                            <div class="card-informacion">
                                                                <div class="card-top">
                                                                    <h6
                                                                        ...
                                                                        Insumos</h6>
                                                                    <button type="button"
                                                                        class="btn btn-info btn-xxs float-md-right d-inline btn-agregar-insumo-urgencia"
                                                                        data-toggle="modal"
                                                                        data-target="#modal_insumos_urgencias"><i
                                                                            class="fas fa-plus"></i>
                                                                        Agregar
