<div id="modal_interconsulta_to" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal_interconsulta_to" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-center">Interconsulta Siquiatría</h5>
...
<script>
    function ind_ic_to() {
        $('#modal_interconsulta_to').modal('show');
    }
</script>
