<div id="m_consent_kine" class="modal fade " tabindex="-1" role="dialog" aria-labelledby="m_consent_kine" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header bg-info">
				<h5 class="modal-title text-white text-center">Consentimiento informado para tratamiento kinesiológico </h5>
			...
			<div class="modal-body">
				...
				<div class="form-row">
					<div class="col-md-12">
						<p>Yo, <strong>{{ $paciente->nombres}} {{ $paciente->apellido_uno }} {{ $paciente->apellido_dos }}</strong> , doy mi consentimiento para participar en el programa de tratamiento kinesiológico ofrecido por el profesional <strong>Dr.{{ $profesional->nombre }} {{ $profesional->apellido_uno }} {{ $profesional->apellido_dos }} </strong>.
                        Entiendo que el programa incluye una evaluación kinesiológica, un plan de tratamiento personalizado y seguimiento para ayudarme a alcanzar mis objetivos de salud. Se me ha explicado que este plan puede incluir cambios en mi dieta, patrones de actividad física y hábitos de ejercicio. También se me ha informado sobre los posibles beneficios y riesgos asociados con este plan. Estoy de acuerdo con este plan y estoy dispuesto a seguirlo de acuerdo con mis posibilidades y circunstancias. Entiendo que puedo revocar mi consentimiento en cualquier momento.
                        </p>
                          <p>
                        Se me ha indicado la necesidad de advertir de mis posibles alergias medicamentosas,alteraciones del sistema músculo-esquelético, insuficiencia respiratoria, alteraciones de la coagulación, existencia de prótesis, marcapasos, medicaciones actuales o cualquier otra circunstancia.
                        </p>
...
<script>
   function conset_ttokine() {
            $('#m_consent_kine').modal('show');
        }
