<div id="glasgow_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="glasgow_modal_label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title mt-1" id="modal_eval_hab_preart">Escala de Glasgow</h5>
...
<script>
    ...
    function mostrara() {
        ...
        cajaglasgow["total"].value = (resultado);
        $('#puntos_glasgow').val(resultado);
        cargarIgual('puntos_glasgow');
    }
