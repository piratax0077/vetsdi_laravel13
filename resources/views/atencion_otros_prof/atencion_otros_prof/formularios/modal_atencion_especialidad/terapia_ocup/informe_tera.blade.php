<div id="informe_tera" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="informe_tera" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
		<div class="modal-content" >
			<div class="modal-header bg-info">
				<h5 class="modal-title text-white mt-1">INFORME TERAPIA OCUPACIONAL</h5>
...
<script>
    function informe_tera() {
        $('#informe_tera').modal('show');
    }
</script>
