<div id="modal_inyect_cd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal_inyect_cd" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title mt-1">Tratamiento inyectable</h5>
