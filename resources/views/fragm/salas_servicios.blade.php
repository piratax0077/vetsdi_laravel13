                ...
                <div class="tab-pane fade " id="p-profesionales_servicio{{ $servicio->id }}" role="tabpanel" aria-labelledby="p-profesionales_servicio-tab{{ $servicio->id }}">
                    ...
                    <div class="row">
                        <div class="col-3">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary has-ripple" onclick="asociar_profesional();"><i class="fa fa-plus" aria-hidden="true"></i> Asociar profesional<span class="ripple ripple-animate" ></span></button>
                        </div>
                        <div class="col-9">
