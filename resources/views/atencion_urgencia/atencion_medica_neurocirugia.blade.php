@extends('template.template_neurocirugia')
@section('Content')
    ...
    <div class="pcoded-main-container">
                    ...
                    <div class="row align-items-center pb-2">
                        <div class="col-md-6">
                            <div class="page-header-title">
                                <h5 class="text-white d-inline f-16 mt-1"><strong>ATENCIÓN NEUROCIRUGÍA</strong></h5>
                ...
                <div class="col-md-12">
                    <div class="tab-content" id="at-orl">
                        ...
                        <div class="tab-pane fade show active" id="atender" role="tabpanel" aria-labelledby="atender-tab">
                            @include('atencion_medica.secciones_especialidad.ficha_neurocirugia')
                        </div>
                        <!--Licencia-->
        ...
        @include("atencion_medica.include.sidebar_derecho_neurocirugia"){{-- modales y data de sidebar especialidad --}}
