...
@section('page-script-ficha-atencion')
    ...
    $('#neuro_cir').change(function() {
        if ($('#neuro_cir').is(':checked')) {
    ...
    {
        element = document.getElementById("contentTto_neuro");
        check = document.getElementById("tto_neuro");
        if (check.checked) {
    ...
    function showContentProc_neuro() {
        element = document.getElementById("contentProc_neuro");
        check = document.getElementById("pr_neuro");
        if (check.checked) {
            element.style.display='block';
        }
        else {
