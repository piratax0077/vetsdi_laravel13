    ...
    <div id="form_neuro" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
        <header class="bs-canvas-header p-3 bg-info overflow-auto">
            ...
            <h5 class="d-inline-block text-light mb-0 float-right">Formularios Neurología</h5>
        </header>
                ...
                <div class="card-sidebar">
                    ...
                    <div id="collapse_evaluaciones" class="collapse" aria-labelledby="heading_evaluaciones" data-parent="#accordion_side_bar">
                         <div class="card-body-sidebar">
                            ...
                            <button type="button" class="btn btn-sm btn-info btn-block text-left" onclick="postura_m();"><i class="fa fa-plus"></i> Examen Motor Postura</button>
