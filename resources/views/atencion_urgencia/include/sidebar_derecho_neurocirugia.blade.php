    ...
    <div id="form_neurocirugia" class="bs-canvas bs-canvas-anim bs-canvas-right position-fixed bg-light h-100 shadow-lg" data-width="370px" data-offset="true">
        <header class="bs-canvas-header p-3 bg-info overflow-auto">
            ...
            <h5 class="d-inline-block text-light mb-0 float-right">Formularios Neurocirugía</h5>
        </header>
