<div id="indicar_examenes" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="indicar_examen"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white mt-1" id="modal_indicar_examen">Indicar Examenes especialidad</h5>
...
<script>
    ...
    {
        $('#indicar_examenes_cd').modal('show');
    }
    function cerrarsol_examen_cd() {
        $('#indicar_examenes_cd').modal ('hide');
      }
