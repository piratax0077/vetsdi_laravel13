<div id="m_indicar_examenescd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="m_indicar_examencd"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white mt-1" id="modal_indicar_examen">Indicar Examen Esp</h5>
...
<script>
    ...
    function cd_ind_examenes()
    {
        $('#m_indicar_examenes_cd').modal('show');
    }
    function cerrarsol_examen_cd() {
        $('#m_indicar_examenes_cd').modal ('hide');
      }
