...
@section('Content')
    ...
    <div class="pcoded-main-container">
                ...
                <div class="col-md-12">
                    <div class="tab-content" id="at-orl">
                        ...
                        <div class="tab-pane fade show active" id="atender" role="tabpanel" aria-labelledby="atender-tab">
                            @include('atencion_medica.secciones_especialidad.ficha_neuro')
                        </div>
                        <!--Licencia-->
        ...
        @include("atencion_medica.include.sidebar_derecho_neurologia"){{-- modales y data de sidebar especialidad --}}
