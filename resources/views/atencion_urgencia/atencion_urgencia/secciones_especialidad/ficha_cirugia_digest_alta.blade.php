                                                                                                            ...
                                                                                                            <div class="form-row">
                                                                                                                ...
                                                                                                                <div class="col-md-4">
                                                                                                                    <div class="form-group">
                                                                                                                        <label class="floating-label-activo-sm" for="urgencia_cdga">Es Urgencia Qx.?</label>
                                                                                                                        <select name="urgencia_cdga" id="urgencia_cdga" data-titulo="Estado General del Paciente" data-seccion="Cirugia digest alta" data-tipo="cirugia digest alta" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('urgencia_cdga','div_detalle_urgencia_cdga','obs_urgencia_cdga',2);">
                                                                                                                            <option value="1" selected>No</option>
                                                                                                                            <option value="2">Si</option>
                                                                                                                        </select>
                                                                                                                    </div>
                                                                                                                    <div class="form-group col-md-12" id="div_detalle_urgencia_cdga" style="display:none">
                                                                                            ...
                                                                                            <div id="contentProc_cda" style="display: none;">
                                                                                                <div class="form-row">
                                                                                                    <div class="form-group col-md-4">
                                                                                                        ...
                                                                                                        <input type="text" class="form-control form-control-sm" data-titulo="Tipo Procedimiento" data-seccion="Plan de Tratamiento" data-tipo="Tipo de procedimiento"  name="tipo_proc_cdg" id="tipo_proc_cda">
                                                                                                    </div>
