<div class="user-profile user-card mt-0z"style="background-color: #ecf0f5!important;">
    <div class="row mx-3 mt-4">
            <ul class="nav nav-tabs-secciones mb-3 mt-3" id="orl" role="tablist">
                <li class="nav-item-secciones">
                    <a class="nav-secciones active text-uppercase  mx-3" id="atencion_cirugia_gen-tab" data-toggle="tab" href="#atencion_cirugia_gen" role="tab" aria-controls="atencion_orl" aria-selected="true">Atención Enfermería</a>
                </li>
			</ul>
        </div>
    <div class="row mx-0">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <ul class="nav nav-tabs-secciones mb-3 mt-3" id="orl" role="tablist">
                <li class="nav-item-secciones">
                    <a class="nav-secciones active text-uppercase" id="atencion_cirugia_gen-tab" data-toggle="tab" href="#atencion_cirugia_gen" role="tab" aria-controls="atencion_orl" aria-selected="true">Atención Médica</a>
                </li>
			</ul>
        </div>
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        @include('atencion_urgencia.generales.seccion_receta_examen_comunes')
