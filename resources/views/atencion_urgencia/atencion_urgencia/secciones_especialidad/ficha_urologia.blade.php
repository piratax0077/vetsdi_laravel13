                                                                                            ...
                                                                                            <div class="form-row">
                                                                                                ...
                                                                                                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                                                                                    <div class="form-group">
                                                                                                        ...
                                                                                                        <select name="urgencia_cdg" id="urgencia_cdg" data-titulo="Es Urgencia Qx.?" data-seccion="Urología" data-tipo="urología" class="form-control form-control-sm" onchange="evaluar_para_carga_detalle('urgencia_uro','div_detalle_urgencia_uro','obs_urgencia_uro',2);">
						...
						<div class="tab-pane fade" id="cisto" role="tabpanel" aria-labelledby="cisto-tab">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center mb-3">
                                        ...
                                        <bottom type="bottom" class="btn btn-secondary mt-1" onclick="visualizar_pdf_examen('cisto');">Ver Examen PDF</bottom>
                                    </div>
                                </div>
							</div>
						  <!--CIERRE: CISTOSCOPÍA-->
						...
						<div class="tab-pane fade" id="uroflujo" role="tabpanel" aria-labelledby="uroflujo-tab">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center mb-3">
                                    ...
                                    <buttom type="buttom" class="btn btn-secondary mt-1" onclick="visualizar_pdf_examen('uro_flujo');">Ver Examen PDF</buttom>
                                </div>
                            </div>
						</div>
                        <!--CIERRE UROFLUJO-->
