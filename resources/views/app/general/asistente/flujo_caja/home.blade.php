                                                                    ...
                                                                    @foreach($bono as $key_b => $value_b)
                                                                        <tr >
                                                                            ...
                                                                            <td class="align-middle text-center">
                                                                                <img src="{{ asset('images/qr-demo-bono.svg') }}"
                                                                                     alt="QR de demostracion"
                                                                                     title="Imagen temporal hasta recibir el QR real"
                                                                                     style="width:54px;height:63px;object-fit:contain;">
                                                                            </td>
                                                                            <td class="align-middle">
                                                                                @if((int) $value_b->estado_consulta === 2)
                                                                                    <span class="badge badge-warning">Pendiente de atencion</span>
                                                                                @elseif((int) $value_b->estado_consulta === 6)
                                                                                    <span class="badge badge-success">Atencion finalizada</span>
                                                                                @else
