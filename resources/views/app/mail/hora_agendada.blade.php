                        ...
                        <tr>
                            <td align="center" style="padding:0px 35px 10px 35px;">
                                ...
                                ">
                                    ...
                                    tu cita fue registrada exitosamente en nuestro sistema veterinario.
                                </p>
                                    ...
                                    <tr>
                                        ...
                                        ">
                                            ...
                                            @if(!empty($detalle['body']['mascota_nombre']))
                                                ...
                                                <b style="color:#0cb9b9;">Mascota:</b><br>
                                                {{ $detalle['body']['mascota_nombre'] }}

                                                @if(!empty($detalle['body']['mascota_especie']))
                                                    ({{ $detalle['body']['mascota_especie'] }})
                                                @endif
                                            @endif
                                ...
                                ">
                                    <tr>
                                        ...
                                        ">
                                            ...
                                            Recuerde confirmar previamente su hora y llegar
                                            15 minutos antes a su cita.
