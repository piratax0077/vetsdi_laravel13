<div id="fracturas_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="fracturas_modal"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title mt-1 f-18" id="modal_info1"> Antecedentes fracturas patológicas</h5>
            ...
            <div class="modal-body">
                <div class="row pt-2 mb-3">
                    <div class="col-md-12">
                        <h6 id="ant_3" class="text-primary" style="cursor: pointer;">Añadir antecedente <i
                    ...
                    <div class="col-md-12">
                        <form id="form_antecedente_fractura" method="POST"
                            ...
                            <input type="hidden" name="paciente_antecedente_fractura_atencion_dental"
                                id="paciente_antecedente_fractura_atencion_dental" value="{{ $paciente->id }}">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="fracturas_dental"
                                ...
                                <tbody>
                                    @if (isset($fracturas_paciente))
                                        @foreach ($fracturas_paciente as $frac_pac)
                                            <tr>
                                                <td class="text-center align-middle">{{ $frac_pac->created_at }}</td>
                                                <td class="text-center align-middle">{{ $frac_pac->procedimiento }}
                                                </td>
                                                <td class="text-center align-middle">
                                                    {{ $frac_pac->id_lugar_atencion }}
                                                </td>
                                                <td class="text-center align-middle">{{ $frac_pac->rut_responsable }}
                                                </td>
                                                <td class="text-center align-middle">
                                                    {{ $frac_pac->detalle_tratamiento }}</td>
                                            </tr>
                                        @endforeach
                                    @endif
