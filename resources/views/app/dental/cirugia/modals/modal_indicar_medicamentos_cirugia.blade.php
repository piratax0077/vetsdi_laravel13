<div id="indicar_medicamentos_cirugia" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="indicar_medicamentos" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form id="form_indicar_medicamento_fiche_demtal">
                    <div class="form-row">
                        ...
                        <div class="col-sm-12">
                            <button type="button" onclick="agregar_medicamento_cirugia(0)"
                ...
                <form>
                    <div class="col-sm-12 mt-3">
                        ...
                        <div class="table-responsive">
                            <table id="tabla_indicar_medicamento_fd" class="table table-bordered table-xs">
                                <thead>
                                    <tr>
