                    ...
                    <div class="row align-items-center pb-2">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="text-white d-inline f-18 mt-1"><strong>ATENCIÓN ENFERMERA DE {{ $servicio->nombre }}</strong></h5>
                        ...
                        <div class="col-md-12">
                            <div class="tab-content" id="at-oftalmo">
                                ...
                                <div class="tab-pane fade show active" id="atender" role="tabpanel" aria-labelledby="atender-tab">
                                    {{-- @include('page.enfermera.secciones_ficha.ficha_urgencia') --}}
                                    @include('app.adm_hospital.servicios.enfermera.secciones_ficha.ficha_servicio')
                                </div>
                                <!--Licencia-->
