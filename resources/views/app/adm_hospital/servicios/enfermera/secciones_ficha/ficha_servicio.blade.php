        ...
        <div class="tab-content" id="orl-contenido">
            ...
            <div class="tab-pane fade show active" id="atencion_enfermeria" role="tabpanel" aria-labelledby="atencion_enfermeria-tab">
                ...
                <div class="row">
                    ...
                    <!--ATENCION ENFERMERIA-->
                    @include('app.adm_hospital.servicios.enfermera.secciones_ficha.control_enfermeria')
                    @include('app.adm_hospital.servicios.enfermera.secciones_ficha.informe_hosp_enf')
