    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title mt-1" id="modal_eval_hab_preart">Indice de Barthel </h5>
                            ...
                            <form name="sumarbarthel">
                                <div class="form-row">
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            <label class="floating-label-activo-sm bart_com_" for="bart_com_" >Comer</label>
                                            <select name="bart_com_" id="bart_com_" class="form-control form-control-sm">
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <select name="bart_lav" id="bart_lav" class="form-control form-control-sm">
                                                <option value="0">Seleccione</option>
                                                <option value="5">Independiente entra y sale del baño</option>
                                                <option value="0">Dependiente</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <select name="bart_vest" id="bart_vest" class="form-control form-control-sm">
                                                <option value="0">Seleccione</option>
                                                <option value="10">Independiente capaz de ponerse y quitarse la ropa abotonarse atar sus zapatos</option>
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <select name="bart_arr" id="bart_arr" class="form-control form-control-sm">
                                                <option value="0">Seleccione</option>
                                                <option value="5">-Independiente para lavarse las manos peinarse afeitarse etc.</option>
                                                <option value="0">Dependiente</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <select name="bart_micc" id="bart_micc" class="form-control form-control-sm">
                                                <option value="0">Seleccione</option>
                                                <option value="10">-Continente o es capaz de cuidarse la sonda</option>
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <select name="bart_retr" id="bart_retr" class="form-control form-control-sm">
                                                <option value="0">Seleccione</option>
                                                <option value="10">Independiente para ir al wc quitarse y ponerse la ropa</option>
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <select name="bart_trasl" id="bart_trasl" class="form-control form-control-sm">
                                                <option value="0">Seleccione</option>
                                                <option value="15">Independiente para ir del sillón a la cama</option>
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <select name="bart_deamb" id="bart_deamb" class="form-control form-control-sm">
                                                <option value="0">Seleccione</option>
                                                <option value="15">Independiente camina solo 50 mts</option>
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <select name="bart_esc" id="bart_esc" class="form-control form-control-sm">
                                                <option value="0">Seleccione</option>
                                                <option value="10">Independiente para subir y bajar escaleras</option>
...
<script>
    ...
    function ps_barthel() {
        ...
        console.log($('#bart_com_').val());
        caja_barthel = document.forms["sumarbarthel"].elements;
        numero1 = $('#bart_com_').val();
        numero2 = $('#bart_lav').val();
        numero3 = $('#bart_vest').val();
        numero4 = $('#bart_arr').val();
        numero5 = $('#bart_dep').val();
        numero6 = $('#bart_micc').val();
        numero7= $('#bart_retr').val();
        numero8 = $('#bart_trasl').val();
        numero9 = $('#bart_deamb').val();
        numero10 = $('#bart_esc').val();
        console.log('mostrar');
        console.log('barthel');
        ...
        $('#total_bart').val(resultado);
        $('#puntos_barthel').val(resultado);
