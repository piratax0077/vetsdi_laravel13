    ...
    <div class="pcoded-main-container">
        <div class="pcoded-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class=" font-weight-bold">Administrador general Vacunatorio</h5>
                            </div>
                            <ul class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="card subir py-auto bg-info">
                        <div class="card-body text-center">
                             <h5 class=" mb-0 text-white f-24">Vacunatorio {{ mb_strtoupper($institucion->nombre) }}</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row row-cols-2 row-cols-md-2 row-cols-lg-2 row-cols-xl-4">
                    ...
                    <div class="card subir py-auto">
                        <a href="{{ ROUTE('adm_cm.configuracion') }}">
                            <div class="card-body text-center" style="cursor:pointer">
                                ...
                                <h6 class="mt-2 mb-0">Configurar mi Vacunatorio</h6>
                            </div>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="card subir py-auto">
                        <a href="{{ ROUTE('adm_cm.profesionales_institucion') }}">
                            <div class="card-body text-center" style="cursor:pointer">
                                ...
                                <h6 class="mt-2 mb-0">Profesionales del vacunatorio</h6>
                            </div>
                        </a>
                    </div>
                     ...
                     <div class="card subir py-auto">
                        <a href="{{ ROUTE('adm_cm.mis_profesionales') }}">
                            <div class="card-body text-center" style="cursor:pointer">
                                ...
                                <h6 class="mt-2 mb-0">Info Profesionales del vacunatorio</h6>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col">
                   <div class="card subir py-auto">
                       <a href="{{ ROUTE('vacunatorio.vacunatorio_pedidos') }}">
                            <div class="card-body text-center" style="cursor:pointer">
