    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title d-inline mt-1">Convenio para profesional {{ $profesional->nombre }} {{ $profesional->apellido_uno }} {{ $profesional->apellido_dos }}</h5>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row d-none" id="contenedor_tipo_convenio_prevision">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="floating-label-activo-sm">Observaciones</label>
                                                            <textarea name="observaciones_nuevo_convenio_prevision" id="observaciones_nuevo_convenio_prevision" cols="30" rows="3" class="form-control form-control-sm"></textarea>
                                                        </div>
                                                    </div>
...
function guardar_nuevo_convenio_institucion(){
        ...
        var id_lugar_atencion = "{{ optional($institucion ?? null)->id_lugar_atencion ?? 0 }}"; // Compatibilidad para usuarios sin institución
    ...
    function _actualizar_campos_fonasa() {
        ...
        if (fonasa_activo) {
            $('#col_nivel_fonasa, #col_copago_fonasa, #col_bono_fonasa, #col_tpo_espera_fonasa').removeClass('d-none');
        } else {
            $('#col_nivel_fonasa, #col_copago_fonasa, #col_bono_fonasa, #col_tpo_espera_fonasa').addClass('d-none');
