...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        ...
        @include('app.adm_cm.partials.usuarios_tablas_nav', ['seccionUsuarios' => 'contratos'])
        <div class="row">
                                                    ...
                                                    <tbody>
                                                        @if($lista_administrativo)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="align-middle">
                                                                    @php
                                                                        $direccionAdministrativo = $administrativo->direccion()->first();
                                                                        $ciudadAdministrativo = $direccionAdministrativo?->ciudad()->first();
                                                                    @endphp
                                                                    @if($direccionAdministrativo)
                                                                        {{ $direccionAdministrativo->direccion }}{{ $direccionAdministrativo->numero_dir ? ' #'.$direccionAdministrativo->numero_dir : '' }}{{ $ciudadAdministrativo ? ', '.$ciudadAdministrativo->nombre : '' }}
                                                                    @else
                                                                        <span class="text-muted">Sin direcci&oacute;n registrada</span>
                                                                    @endif
                                                                </td>
                                                                <td class="align-middle">
                                                                    <!--Botón Modal-->
