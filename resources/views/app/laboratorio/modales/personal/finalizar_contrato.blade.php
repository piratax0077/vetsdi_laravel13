    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="modal_finalizar_empleado_id_lugar_atencion" id="modal_finalizar_empleado_id_lugar_atencion" value="">
                <div class="row">
                    <div class="col-sm-12">
                        <h5>
...
<script>
    function modal_desactivar_profesional(id, id_contrato, nombre, id_lugar_atencion)
    {
        ...
        $('#modal_finalizar_empleado_id_lugar_atencion').val(id_lugar_atencion);
    }
    ...
    function finalizar_personal_profesional()
    {
        ...
        let id_lugar_atencion = $('#modal_finalizar_empleado_id_lugar_atencion').val();
        let _token = CSRF_TOKEN;

        let url = "{{ route('laboratorio.personal.finalizar_profesional') }}";
        $.ajax({
            url: url,
            type: "post",
            data: {
