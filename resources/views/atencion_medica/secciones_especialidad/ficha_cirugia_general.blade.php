            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <ul class="nav nav-tabs-secciones mb-3 mt-3" id="orl" role="tablist">
                    <li class="nav-item-secciones">
                        ...
                        <a class="nav-secciones text-uppercase" id="operacion-cx-tab" data-toggle="tab" href="#operacion-cx" role="tab" aria-controls="operacion-cx" aria-selected="true">Cirugía</a>

                        <a class="nav-secciones  text-uppercase" id="presupuesto-cx-tab" data-toggle="tab" href="#presupuesto-cx" role="tab" aria-controls="presupuesto-cx" aria-selected="true">Presupuesto</a>
                    </li>
				</ul>
            </div>
           <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <form action="{{ route('fichaAtencion.registrar_ficha_cg') }}" method="POST">
                    ...
                    <div class="tab-content" id="orl-contenido">
                        ...
                        <!--FICHA CIRUGÍA-->
                        <div class="tab-pane fade" id="operacion-cx" role="tabpanel" aria-labelledby="operacion-cx-tab">
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <h5 class="f-20 mb-3 text-purple">Ficha de Cirugía</h5>
                                </div>
                                <!--MEDICAMENTOS ADMINISTRADOS EN LA CX-->
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="card-a">
                                        <div class="card-header-a">
                                            <h5 class="mt-2">Medicamentos</h5>
                                        </div>
                                        <div class="card-body-aten-a">
                                             <div class="form-row">
                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                     <label class="floating-label-activo-sm" for="motivo">Medicamento</label>
                                                ...
                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-2 col-xxl-2">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" name="ultima_desparasitacion" id="ultima_desparasitacion" value="">
                                                </div>
                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-2 col-xxl-2">
                                                    <label class="floating-label-activo-sm">Vía</label>
                                                    <input type="text" class="form-control form-control-sm" name="ultima_desparasitacion" id="ultima_desparasitacion" value="">
                                                </div>
                                                <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-2 col-xxl-2">
                                                    <button type="button" class="btn btn-sm btn-info btn-block">+ Añadir</button>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-12">
                                                        ...
                                                        <table class="table table-bordered table-xs">
                                                          ...
                                                          <tbody>
                                                            <tr>
                                                              ...
                                                              <td>Venosa</td>
                                                              <td>00:00</td>
                                                              <td><button type="button" class="btn btn-icon btn-danger-light-c"><i class="fas fa-minus"></i></button></td>
                                                            </tr>
                                                          </tbody>
                                                        </table>
                                                    </div>
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="card-a">
                                        ...
                                        <div class="card-body-aten-a">
                                             <div class="form-row">
                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                     <label class="floating-label-activo-sm" for="motivo">Insumos</label>
                                                    <select class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                        <option value="">Seleccione</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-sm-12 col-md-6 col-lg-3 col-xl-3 col-xxl-3">
                                ...
                                <!--EVOLUCIONES EN LA CX DE LA MASCOTA-->
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                             <div class="form-row">
                                                 <div class="form-group col-sm-12 col-md-9 col-lg-10 col-xl-10 col-xxl-10">
                                                    <label class="floating-label-activo-sm" for="motivo">Comentarios de la cirugía</label>
                                                ...
                                                <div class="form-group col-sm-12 col-md-3 col-lg-2 col-xl-2 col-xxl-2">
                                                    <button type="button" class="btn btn-sm btn-info btn-block">+ Añadir</button>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <!--CIERRE: FICHA CIRUGÍA-->

                        <!--PRESUPUESTO CX-->
                        <div class="tab-pane fade" id="presupuesto-cx" role="tabpanel" aria-labelledby="presupuesto-cx-tab">
                            <div class="form-row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <h5 class="text-purple f-20 mb-3">Presupuesto de Cirugía</h5>
                                </div>
                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form-row">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                                                    <div class="card-lineal">
                                                        <div class="card-header-lineal">
                                                            <h5 class="t-modal pt-1">Información Cirugía</h5>
                                                        </div>
                                                        <div class="card-body-lineal">
                                                            <div class="form-row">
                                                                <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                    <label class="floating-label-activo-sm" for="motivo">Cirugía</label>
                                                                    <select class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                        <option value="">Seleccione</option>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                                                    <label class="floating-label-activo-sm" for="motivo">Nombre 1er Cirujano</label>
                                                                    <input type="text" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                                                    <label class="floating-label-activo-sm" for="motivo">Nombre 2do Cirujano</label>
                                                                    <input type="text" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                                                    <label class="floating-label-activo-sm" for="motivo">Nombre Anestesista</label>
                                                                    <input type="text" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                                                    <label class="floating-label-activo-sm" for="motivo">Pabellón</label>
                                                                    <input type="text" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <!--DETALLE VALORES PRESUPUESTO-->
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                                                    <div class="card-lineal">
                                                        <div class="card-header-lineal">
                                                            <h5 class="t-modal pt-1">Detalle Presupuesto</h5>
                                                        </div>
                                                        <div class="card-body-lineal">
                                                            <div class="form-row">
                                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-4">
                                                                    <label class="floating-label-activo-sm" for="motivo">Valor Base Cirugía</label>
                                                                    <input type="number" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-4">
                                                                    <label class="floating-label-activo-sm" for="motivo">Valor 1do Cirujano</label>
                                                                    <input type="number" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-4">
                                                                    <label class="floating-label-activo-sm" for="motivo">Valor 2do Cirujano</label>
                                                                    <input type="number" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-4">
                                                                    <label class="floating-label-activo-sm" for="motivo">Valor Anestesista</label>
                                                                    <input type="number" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-4">
                                                                    <label class="floating-label-activo-sm" for="motivo">Valor Pabellón</label>
                                                                    <input type="number" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-4">
                                                                    <label class="floating-label-activo-sm" for="motivo">Valor Implantes</label>
                                                                    <input type="number" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-4">
                                                                    <label class="floating-label-activo-sm" for="motivo">Valor Hospitalización</label>
                                                                    <input type="number" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-4">
                                                                    <label class="floating-label-activo-sm" for="motivo">Valor Medicamentos</label>
                                                                    <input type="number" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                                <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-4">
                                                                    <label class="floating-label-activo-sm" for="motivo">Valor Insumos</label>
                                                                    <input type="number" class="form-control form-control-sm" name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                            </div>
                                                             <div class="form-row">
                                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                                                                    <h6 class="bg-purple text-white p-2">VALOR TOTAL</h6>
                                                                </div>
                                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-8 col-xxl-9">
                                                                    <input type="number" class="border-purple text-purple font-weight-bold form-control form-control-sm " name="esterilizado" id="esterilizado" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                    <div class="card-lineal">
                                                        <div class="card-header-lineal">
                                                            <h5 class="t-modal pt-1">Procedimiento</h5>
                                                        </div>
                                                        <div class="card-body-lineal">
                                                             <div class="form-row">
                                                                 <div class="form-group col-12">
                                                                    <label class="floating-label-activo-sm" for="motivo">Descripción</label>
                                                                     <textarea class="form-control caja-texto form-control-sm mb-9" rows="1" onfocus="this.rows=4" onblur="this.rows=1;" name="cirugias_previas" id="cirugias_previas"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
