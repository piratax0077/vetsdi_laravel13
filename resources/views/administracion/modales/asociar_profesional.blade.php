...
<div id="asociar_profesional_sdi" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="asociar_profesional_sdi" aria-hidden="true">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="agregar_profesional_cargo_int" id="agregar_profesional_cargo_int" onchange="registrar_nuevo_servicio(event)">
                                        ...
                                        <option value="1">Jefatura Médica</option>
                                        <option value="2">Médico Turno y llenado antecedentes</option>
                                        <option value="3">Médico Turno </option>
                                    </select>
                                </div>
                            </div>
