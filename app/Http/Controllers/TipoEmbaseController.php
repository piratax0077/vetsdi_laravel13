...
use App\Models\TipoEmbase;
use Illuminate\Http\Request;

class TipoEmbaseController extends Controller
{
    ...
    public function verRegistros($id, $estado)
    {
        ...
        if($valido)
        {
            ...
            $registro = TipoEmbase::where($filtro)->get();
            if($registro)
            {
                $datos['estado'] = 1;
                $datos['msj'] = 'registro';
