...
class CuracionesPieDiabetico extends Model
{
    use HasFactory;

    protected $table = 'curaciones_pie_diabetico';
    ...
    protected $casts = [
        'datos_valoracion_pie_diabetico' => 'array',
        'datos_curacion_pie_diabetico' => 'array',
        'created_at' => 'datetime',
        'updated_at' => 'datetime',
    ];
